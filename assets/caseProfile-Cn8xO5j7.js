import{c as D}from"./createLucideIcon-Cw7p0jvg.js";import{p as U,a as Q,S as O,L as K,H as Te,o as ee,w as Je,F as ke,T as xe,W as te,X as ne,Y as Ge}from"./tokenService-BGqefhby.js";import{l as Xe,a as Ze}from"./index-BfrPZkLz.js";/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const We=[["path",{d:"m15 18-6-6 6-6",key:"1wnfg3"}]],Sn=D("chevron-left",We);/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qe=[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]],_n=D("chevron-right",Qe);/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const et=[["rect",{width:"8",height:"4",x:"8",y:"2",rx:"1",ry:"1",key:"tgr4d6"}],["path",{d:"M8 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2",key:"4jdomd"}],["path",{d:"M16 4h2a2 2 0 0 1 2 2v4",key:"3hqy98"}],["path",{d:"M21 14H11",key:"1bme5i"}],["path",{d:"m15 10-4 4 4 4",key:"5dvupr"}]],Cn=D("clipboard-copy",et);/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const tt=[["path",{d:"M15 3h6v6",key:"1q9fwt"}],["path",{d:"M10 14 21 3",key:"gplh6r"}],["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}]],An=D("external-link",tt);/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const nt=[["path",{d:"M15.39 4.39a1 1 0 0 0 1.68-.474 2.5 2.5 0 1 1 3.014 3.015 1 1 0 0 0-.474 1.68l1.683 1.682a2.414 2.414 0 0 1 0 3.414L19.61 15.39a1 1 0 0 1-1.68-.474 2.5 2.5 0 1 0-3.014 3.015 1 1 0 0 1 .474 1.68l-1.683 1.682a2.414 2.414 0 0 1-3.414 0L8.61 19.61a1 1 0 0 0-1.68.474 2.5 2.5 0 1 1-3.014-3.015 1 1 0 0 0 .474-1.68l-1.683-1.682a2.414 2.414 0 0 1 0-3.414L4.39 8.61a1 1 0 0 1 1.68.474 2.5 2.5 0 1 0 3.014-3.015 1 1 0 0 1-.474-1.68l1.683-1.682a2.414 2.414 0 0 1 3.414 0z",key:"w46dr5"}]],En=D("puzzle",nt),rt=/\.(jpe?g|png|webp|gif|bmp|avif)(?:$|[?#])/i,ot=/\.pdf(?:$|[?#])/i,at=["{contractor}","{contractor_number}","{client_contractor_number}"];function y(...e){for(const t of e){const n=String(t??"").trim();if(n)return n}return""}function it(e){if(e&&typeof e=="object"&&!Array.isArray(e))return e;if(typeof e!="string")return null;try{const t=JSON.parse(e);return t&&typeof t=="object"&&!Array.isArray(t)?t:null}catch{return null}}function st(e="",t=""){const n=`${e} ${t}`;return rt.test(n)?"image":ot.test(n)?"pdf":"file"}function lt(e=""){const t=String(e||"").trim().toLowerCase();return t==="image"||t.startsWith("image/")}function ct(e={}){var t,n,o;return y(e.date,e.messageDate,e.messageDateTime,e.createdAt,e.created,e.sentAt,e.receivedAt,e.timestamp,(t=e.message)==null?void 0:t.date,(n=e.message)==null?void 0:n.createdAt,(o=e.message)==null?void 0:o.sentAt)||null}function ut(e,t){var s,i;if(!e||typeof e!="object"||Array.isArray(e))return null;const n=y(e.url,e.href,e.src,e.downloadUrl);if(!n)return null;const o=y(e.name,e.filename,e.fileName,e.title,decodeURIComponent(((s=String(n).split("/").pop())==null?void 0:s.split("?")[0])||""))||`Attachment ${t+1}`,r=y(e.type,e.contentType,e.mimeType),a=lt(r)?"image":st(o,n);return{id:y(e.id,e.attachmentId,e.documentId)||`${t}-${o}-${n}`,name:o,url:n,type:a,size:y(e.size,e.sizeText,e.fileSize)||null,messageId:y(e.messageId,e.messageID,(i=e.message)==null?void 0:i.id)||null,date:ct(e)}}function fe(e){return String(e).padStart(2,"0")}function dt(e){const t=e.getFullYear(),n=fe(e.getMonth()+1),o=fe(e.getDate());return{dateKey:`${t}-${n}-${o}`,label:`${o}.${n}.${t}`,sortValue:new Date(t,e.getMonth(),e.getDate()).getTime()}}function mt(e){if(e==null||e==="")return null;if(typeof e=="number"&&Number.isFinite(e)){const a=new Date(e);return Number.isNaN(a.getTime())?null:a}const t=String(e).trim();if(!t)return null;const n=t.match(/\b(\d{1,2})[./-](\d{1,2})[./-](\d{2,4})\b/);if(n){const a=Number(n[1]),s=Number(n[2])-1,i=Number(n[3]),u=i<100?2e3+i:i,f=new Date(u,s,a);if(!Number.isNaN(f.getTime()))return f}const o=t.match(/\b(\d{4})[./-](\d{1,2})[./-](\d{1,2})\b/);if(o){const a=new Date(Number(o[1]),Number(o[2])-1,Number(o[3]));if(!Number.isNaN(a.getTime()))return a}const r=new Date(t);return Number.isNaN(r.getTime())?null:r}function ft(e={}){const t=mt(e.date);return t?dt(t):{dateKey:"unknown",label:"Date non disponible",sortValue:Number.NEGATIVE_INFINITY}}function bt(e,t){const n=y(t);n&&at.forEach(o=>{e[o]=n})}function be(e){return!!(e&&typeof e=="object"&&!Array.isArray(e))}function pt(e,t,n){const o=K(t),r=y(n);!o||!r||e.push([o,r])}function ye(e,t=[]){const n=[];return be(e)&&Object.entries(e).forEach(([o,r])=>{if(be(r)){n.push(...ye(r,[...t,o]));return}pt(n,[...t,o].join("."),r)}),n}function ht(e={}){const t={};return["tokenValues","values","variables","fields"].forEach(n=>{ye(e[n]).forEach(([o,r])=>{t[o]=r})}),t}function q(e=[]){if(!Array.isArray(e))return[];const t=new Set;return e.map(ut).filter(Boolean).filter(n=>{const o=`${n.name}|${n.url}`;return t.has(o)?!1:(t.add(o),!0)})}function P(e=[]){return q(e).filter(t=>t.type==="image")}function Ln(e=[]){const t=new Map;return P(e).forEach((n,o)=>{const r=ft(n);t.has(r.dateKey)||t.set(r.dateKey,{...r,attachments:[]}),t.get(r.dateKey).attachments.push({...n,galleryIndex:o})}),Array.from(t.values()).sort((n,o)=>o.sortValue-n.sortValue)}function Dn(e){var p,b;const t=it(e);if(!t)return{ok:!1,error:"INVALID_SUPER_OFFICE_JSON"};const n=y(t.ticketId,t.soTicket,t.soTicketNumber,t.ticketNumber),o=y(t.createdAt,t.created,t.createdDate,t.ticketCreatedAt,t.ticketCreatedDate),r=y(t.externalTicketId,t.externalId,t.externalID,t.hcampExternalId),a=y(t.contractorNumber,t.contractor,t.contractorNo,t.customerId,t.customer,(p=t.client)==null?void 0:p.contractorNumber,(b=t.client)==null?void 0:b.contractor),s={};let i=null,u=!1;const f=q(t.attachments),l=P(f);if(r){const w=U(r);w.ok&&(u=!0,i=w.fields,Object.assign(s,Q(w.fields)))}Object.assign(s,ht(t));const c=(i==null?void 0:i.customer)||a;c&&(u||n||f.length>0)&&bt(s,c);const d=n||(i==null?void 0:i.soTicket)||"";return d&&(s[O]=d),Object.keys(s).length===0&&f.length===0?{ok:!1,error:"EMPTY_SUPER_OFFICE_DATA",externalIdValid:u,externalTicketId:r}:{ok:!0,ticketId:d,sourceTicketId:n,createdAt:o,externalTicketId:r,contractorNumber:c,externalIdValid:u,externalFields:i,tokenValues:s,attachments:f,imageAttachments:l,ignoredExternalId:!!(r&&!u)}}const re="super_office_ticket_payload",oe="pending_super_office_ticket_payload",gt="super-office-ticket-updated";function Tt(e){if(!e||typeof e!="object"||Array.isArray(e))return e;const{[te]:t,[ne]:n,...o}=e;return o}function J(e){return Array.isArray(e)?`[${e.map(J).join(",")}]`:e&&typeof e=="object"?`{${Object.keys(e).sort().map(t=>`${JSON.stringify(t)}:${J(e[t])}`).join(",")}}`:JSON.stringify(e)}function ae(e=null){if(!e||typeof e!="object"||Array.isArray(e))return"";try{return J(Tt(e))}catch{return""}}function E(e){typeof window>"u"||window.dispatchEvent(new CustomEvent(gt,{detail:{payload:e}}))}function Y(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=q(e.attachments),n=String(e.clientSignature||"").trim(),o=e.tokenValues&&typeof e.tokenValues=="object"&&!Array.isArray(e.tokenValues)?Object.fromEntries(Object.entries(e.tokenValues).map(([r,a])=>[r,a==null?"":String(a)])):{};return{ticketId:String(e.ticketId||"").trim(),sourceTicketId:String(e.sourceTicketId||"").trim(),createdAt:String(e.createdAt||e.created||e.createdDate||"").trim(),externalTicketId:String(e.externalTicketId||"").trim(),importedAt:e.importedAt||new Date().toISOString(),clientSignature:n,tokenValues:o,attachments:t,imageAttachments:P(t)}}function kt(e,t=new Date,n=""){return Y({ticketId:(e==null?void 0:e.ticketId)||"",sourceTicketId:(e==null?void 0:e.sourceTicketId)||"",createdAt:(e==null?void 0:e.createdAt)||"",externalTicketId:(e==null?void 0:e.externalTicketId)||"",importedAt:t.toISOString(),clientSignature:n,tokenValues:(e==null?void 0:e.tokenValues)||{},attachments:(e==null?void 0:e.attachments)||[]})}async function ie(e){e&&await xe(re,e)}async function we(e){e&&await xe(oe,e)}async function H(){try{return Y(await Te(oe,null))}catch(e){return console.error("loadPendingSuperOfficeTicketPayload error",e),null}}function On(){return H()}async function xt(){return await Ie()||await H()}async function Vn(){return!!await xt()}function se(){return ke(oe)}async function jn(e){const t=await ee(),n=kt(e,new Date,ae(t));return n?n.clientSignature?(await ie(n),await se(),E(n),n):(await B(),await we(n),E(null),n):null}async function Fn(e){const t=Je(e);if(!t)return null;const n=await Ie(),o=n?null:await H(),r=n||o;if(!r)return null;const a=U(t),s=a.ok?{...r.tokenValues||{},...Q(a.fields)}:r.tokenValues||{},i=Y({...r,externalTicketId:t,tokenValues:s});return i?(i.clientSignature?await ie(i):await we(i),E(i),i):null}function B(){return ke(re)}async function $n(){const e=await H(),t=ae(await ee());if(!e||!t)return null;const n={...e,clientSignature:t};return await ie(n),await se(),E(n),n}async function Ie(){try{const e=await Te(re,null);if(!e)return null;const t=ae(await ee());if(!t)return await B(),null;if((e==null?void 0:e.clientSignature)!==t)return await B(),null;const n=Y(e);return n||null}catch(e){return console.error("loadSuperOfficeTicketPayload error",e),null}}async function zn(){await B(),await se(),E(null)}const ve="quick_tools",yt="blue",_=Object.freeze({LINK:"link",MODULE:"module"}),wt=_.LINK,It=[{value:"blue",label:"Blue"},{value:"cyan",label:"Cyan"},{value:"emerald",label:"Green"},{value:"amber",label:"Amber"},{value:"rose",label:"Rose"},{value:"violet",label:"Violet"},{value:"slate",label:"Slate"}],vt=new Set(It.map(e=>e.value)),Nt=new Set(Object.values(_));function St(e){return vt.has(e)?e:yt}function Ne(e){return Nt.has(e)?e:wt}function _t(e){const t=Number(e);return Number.isFinite(t)?t:void 0}function Se(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=e.type||(e.html?_.MODULE:_.LINK),n=Ne(t);return{...e,type:n,title:String(e.title||"").trim(),url:n===_.LINK?String(e.url||"").trim():"",description:String(e.description||"").trim(),prompt:String(e.prompt||""),html:String(e.html||""),color:St(e.color),order:_t(e.order),beta:n===_.MODULE?!0:!!e.beta}}async function Bn(){const e=await Xe(ve,[]);return Array.isArray(e)?e.map(Se).filter(Boolean):[]}async function Rn(e){const t=Array.isArray(e)?e.map(Se).filter(Boolean):[];return Ze(ve,t)}function Mn(e,t={}){return(e||"").replace(/\{[^}]+\}/g,n=>{const o=t[n];if(o==null||o==="")return n;const r=String(o).replace(/<[^>]+>/g,"").trim();return encodeURIComponent(r)})}function Un(e){return Ne(e==null?void 0:e.type)===_.MODULE}const R="template-tool-module-beta-1",_e=Object.freeze({name:"Template Generator Module API",version:R,globals:{TemplateTool:{type:"object",description:"Host bridge used by module JavaScript to read data, copy content, show feedback and control the module modal."},TemplateVars:{type:"object",description:"Runtime variables with safe JavaScript property names, populated after TemplateTool.getContext()."},TemplateProfile:{type:"object",description:"Normalized customer profile with easy fields, variables, tokens, photos and attachments."},TemplateEnv:{type:"object",description:"Execution metadata for the current module."},TemplateFields:{type:"array",description:"Normalized visible fields available to the module."},TemplateContext:{type:"object",description:"Full runtime context returned by TemplateTool.getContext()."},TemplateAPI:{type:"object",description:"Static API reference exposed inside every module."}},variables:{access:"await TemplateTool.getContext(); then read window.TemplateVars",examples:["TemplateVars.clientName","TemplateVars.mobile","TemplateVars.contractor","TemplateVars.activationDate","TemplateVars.otoId","TemplateVars.soTicketNum","TemplateVars.byToken['{client_first_name}']","TemplateVars.byKey['client.firstName']","TemplateVars.byLabel['Full name']"],reservedContainers:["env","raw","byToken","byKey","byLabel"]},contextShape:{apiVersion:"string",tool:"{ id: string, title: string, description: string }",environment:"{ apiVersion, toolId, toolTitle, toolDescription, generatedAt }",profile:"normalized customer profile with fields, vars, tokenValues, photos and attachments",variables:"TemplateVars object",values:"token values plus compatibility aliases",tokenValues:"original token-keyed values",tokens:"Array<{ token, label, key, inputType, value, internal, aliases }>",fields:"Array<{ label, value, source, token, key, section, aliases }>",fieldIndex:"normalized lookup object",client:"raw imported client payload or null",clientInfo:"visible client detail sections",clientSummary:"compact client bar fields",generatedAt:"ISO timestamp"},functions:{"TemplateTool.getContext()":"Promise<TemplateContext>","TemplateTool.getProfile()":"Promise<TemplateProfile>","TemplateTool.getVars()":"Promise<TemplateVars>","TemplateTool.getVar(name, fallback = '')":"Promise<string>","TemplateTool.hasVariable(name)":"Promise<boolean>","TemplateTool.listVariables()":"Promise<string[]>","TemplateTool.findField(candidates)":"Promise<Field|null>","TemplateTool.getFieldValue(candidates, fallback = '')":"Promise<string>","TemplateTool.copyText(text, message)":"Promise<{ ok: boolean }>","TemplateTool.copyHtml(html, message)":"Promise<{ ok: boolean }>","TemplateTool.toast(message, variant)":"Promise<{ ok: boolean }>","TemplateTool.openUrl(url)":"Promise<{ ok: boolean }>","TemplateTool.close()":"void","TemplateTool.requestResize()":"void","TemplateTool.onContext(callback)":"unsubscribe function","TemplateTool.describeApi()":"TemplateAPI reference"}});function Ct(e=_e){const t=[`${e.name} (${e.version})`,"","Globals:"];return Object.entries(e.globals||{}).forEach(([n,o])=>{t.push(`- window.${n}: ${o.description}`)}),t.push("","Variable access:",`- ${e.variables.access}`),(e.variables.examples||[]).forEach(n=>{t.push(`- ${n}`)}),t.push(`- Reserved TemplateVars containers: ${(e.variables.reservedContainers||[]).join(", ")}`),t.push("","Context shape:"),Object.entries(e.contextShape||{}).forEach(([n,o])=>{t.push(`- ${n}: ${o}`)}),t.push("","Functions:"),Object.entries(e.functions||{}).forEach(([n,o])=>{t.push(`- ${n}: ${o}`)}),t.join(`
`)}const At=`
...
(function () {
    var apiVersion = "${R}";
    var apiReference = ${JSON.stringify(_e)};
    var requestId = 0;
    var pending = new Map();
...
</html>`:Lt}function Vt(e,t,n){return e.includes(n)?e:/<\/head\s*>/i.test(e)?e.replace(/<\/head\s*>/i,`${t}</head>`):/<head[\s>]/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>${t}`):/<html[\s>]/i.test(e)?e.replace(/<html([^>]*)>/i,`<html$1>${t}`):`${t}${e}`}function jt(e,t,n){return e.includes(n)?e:/<head[\s>]/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>${t}`):/<html[\s>]/i.test(e)?e.replace(/<html([^>]*)>/i,`<html$1>${t}`):`${t}${e}`}function Kn(e=""){const t=Ot(e),n=jt(t,Et,"template-tool-bridge");return Vt(n,At,"template-tool-host-style")}function Ft(e=[],t={}){return Array.isArray(e)?e.filter(n=>n==null?void 0:n.token).map(n=>{const o=Object.prototype.hasOwnProperty.call(t,n.token)?t[n.token]:n.previewValue;return{token:n.token,label:n.label||n.token,key:n.key||"",inputType:n.input_type||n.inputType||"text",value:o??"",internal:!!n.internal,aliases:Array.isArray(n.searchAliases)?n.searchAliases.filter(Boolean):[]}}):[]}function L(e){return e==null?"":typeof e=="string"?e.trim():typeof e=="number"||typeof e=="boolean"?String(e):""}function G(e=""){return String(e||"").replace(/[{}]/g,"").replace(/([a-z0-9])([A-Z])/g,"$1 $2").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/&/g,"and").replace(/[^a-z0-9]+/g,"")}function Ce(e=""){return String(e||"").replace(/[{}]/g,"").replace(/([a-z0-9])([A-Z])/g,"$1 $2").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/&/g,"and").replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}function Ae(e=""){const t=Ce(e);return t?t.replace(/_([a-z0-9])/g,(n,o)=>o.toUpperCase()):""}function Ee(e=""){const t=Ae(e);return t?/^[A-Za-z_$]/.test(t)?t:`field${t.charAt(0).toUpperCase()}${t.slice(1)}`:""}function le(e=""){return String(e||"").split(".").map(t=>t.trim()).filter(Boolean)}function V(e,t){const n=String(t||"").trim();!n||e.includes(n)||e.push(n)}function v(e,t){const n=String(t||"").trim();if(!n)return;V(e,n);const o=Ce(n),r=Ae(n);o&&(V(e,o),V(e,`{${o}}`)),r&&V(e,r)}function $t({label:e="",token:t="",key:n="",aliases:o=[],section:r=""}={}){const a=[];v(a,e),v(a,t),v(a,t.replace(/[{}]/g,"")),v(a,n);const s=le(n);return s.length>0&&(v(a,s[s.length-1]),v(a,s.join(" ")),v(a,s.join(""))),v(a,r),o.forEach(i=>v(a,i)),a}function zt(e){const t=L(e.value);if(t==="")return null;const n={label:String(e.label||e.token||e.key||"Field"),value:t,source:e.source||"context"};return e.token&&(n.token=String(e.token)),e.key&&(n.key=String(e.key)),e.section&&(n.section=String(e.section)),n.aliases=$t({...e,...n}),n}function Bt({tokens:e=[],clientInfo:t=[],clientSummary:n=[],profile:o=null}={}){const r=[],a=new Set,s=i=>{const u=zt(i);if(!u)return;const f=`${u.source}:${u.label}:${u.value}:${u.token||""}:${u.key||""}`;a.has(f)||(a.add(f),r.push(u))};return e.forEach(i=>{s({label:i.label,value:i.value,token:i.token,key:i.key,aliases:i.aliases,source:"token"})}),n.forEach(i=>{s({label:i.label,value:i.value,section:"summary",source:"clientSummary"})}),t.forEach(i=>{((i==null?void 0:i.fields)||[]).forEach(u=>{s({label:u.label,value:u.value,section:i.title||i.id,source:"clientInfo"})})}),o&&typeof o=="object"&&(Array.isArray(o.availableFields)?o.availableFields:[]).forEach(i=>{s({label:i.label,value:i.value,key:i.key,aliases:i.aliases,source:"profile"})}),r}function Rt(e,t,n){!t||n===""||Object.prototype.hasOwnProperty.call(e,t)||(e[t]=n)}function Mt(e,t,n){const o=le(t);if(o.length<2||n==="")return;let r=e;for(let s=0;s<o.length-1;s+=1){const i=o[s];if(!i||/^\d+$/.test(i)||(r[i]===void 0&&(r[i]={}),!r[i]||typeof r[i]!="object"||Array.isArray(r[i])))return;r=r[i]}const a=o[o.length-1];a&&!Object.prototype.hasOwnProperty.call(r,a)&&(r[a]=n)}function Ut(e={},t=[]){const n={...e};return t.forEach(o=>{o.key&&Mt(n,o.key,o.value),o.aliases.forEach(r=>Rt(n,r,o.value))}),Le(n,t),n}const Kt=Object.freeze([{name:"clientName",candidates:["clientName","client name","fullName","full name","name","client.name"]}]);function qt(e,t){const n=G(t);return!e||!n?!1:[e.label,e.token,e.key,...e.aliases||[]].some(o=>G(o)===n)}function Pt(e=[],t=[]){for(const n of t){const o=e.find(a=>qt(a,n)),r=L(o==null?void 0:o.value);if(r!=="")return r}return""}function Le(e,t=[]){Kt.forEach(({name:n,candidates:o})=>{if(Object.prototype.hasOwnProperty.call(e,n))return;const r=Pt(t,o);r!==""&&(e[n]=r)})}function Yt(e=[]){const t={};return e.forEach(n=>{[n.label,n.token,n.key,...n.aliases||[]].forEach(o=>{const r=G(o);!r||t[r]||(t[r]={label:n.label,value:n.value,source:n.source,token:n.token||"",key:n.key||"",section:n.section||""})})}),t}function z(e,t,n){const o=Ee(t);!o||n===""||Object.prototype.hasOwnProperty.call(e,o)||(e[o]=n)}function Ht(e,t,n){const o=le(t).map(Ee).filter(Boolean);if(o.length<2||n==="")return;let r=e;for(let s=0;s<o.length-1;s+=1){const i=o[s];if(r[i]===void 0&&(r[i]={}),!r[i]||typeof r[i]!="object"||Array.isArray(r[i]))return;r=r[i]}const a=o[o.length-1];a&&!Object.prototype.hasOwnProperty.call(r,a)&&(r[a]=n)}function Jt(e,t=null){if(!t||typeof t!="object")return;const n=t.vars&&typeof t.vars=="object"?t.vars:t.variables&&typeof t.variables=="object"?t.variables:{};Object.entries(n).forEach(([o,r])=>{const a=L(r);a!==""&&z(e,o,a)})}function Gt({fields:e=[],tokenValues:t={},environment:n={},profile:o=null}={}){const r={env:n,raw:t,byToken:{},byKey:{},byLabel:{}};return Object.entries(t||{}).forEach(([a,s])=>{const i=L(s);i!==""&&(r.byToken[a]=i,z(r,a,i),z(r,a.replace(/[{}]/g,""),i))}),Jt(r,o),e.forEach(a=>{const s=L(a.value);s!==""&&(a.token&&(r.byToken[a.token]=s),a.key&&(r.byKey[a.key]=s,Ht(r,a.key,s)),r.byLabel[a.label]=s,[a.label,a.token,a.key,...a.aliases||[]].forEach(i=>{z(r,i,s)}))}),Le(r,e),r}function qn({tool:e={},values:t={},tokens:n=[],client:o=null,clientInfo:r=[],clientSummary:a=[],profile:s=null}={}){const i=t&&typeof t=="object"?t:{},u=s&&typeof s=="object"?s:null,f=u!=null&&u.tokenValues&&typeof u.tokenValues=="object"?u.tokenValues:{},l={...i,...f},c=Array.isArray(r)?r:[],d=Array.isArray(a)?a:[],p=Ft(n,l),b=Bt({tokens:p,clientInfo:c,clientSummary:d,profile:u}),w=new Date().toISOString(),I={apiVersion:R,toolId:e.id||"",toolTitle:e.title||"",toolDescription:e.description||"",generatedAt:w};return{apiVersion:R,tool:{id:e.id||"",title:e.title||"",description:e.description||""},profile:u||null,values:Ut(l,b),tokenValues:l,tokens:p,fields:b,fieldIndex:Yt(b),variables:Gt({fields:b,tokenValues:l,environment:I,profile:u}),environment:I,client:o&&typeof o=="object"?o:null,clientInfo:c,clientSummary:d,generatedAt:w}}function Pn({title:e="",prompt:t=""}={}){const n=String(e||"").trim()||"Custom tool",o=String(t||"").trim()||"Create a useful workflow tool for my Template Generator app.";return`You are building a custom Beta module for a local app called Template Generator.
