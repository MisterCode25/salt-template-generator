import{c as J}from"./createLucideIcon-DAlx50CY.js";import{p as Y,b as re,S as j,L as H,H as Ae,o as oe,w as dt,F as Ce,T as _e,W as ae,X as ie,Y as mt}from"./tokenService-BAAMxug8.js";import{l as pt,s as ft}from"./index-B21HftyJ.js";import{l as F,s as se,d as bt}from"./templateTreeService-CSqkRNac.js";import{f as Ee,u as Le}from"./templateTreeOperations-BTnhm2bm.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const kt=[["path",{d:"M15.39 4.39a1 1 0 0 0 1.68-.474 2.5 2.5 0 1 1 3.014 3.015 1 1 0 0 0-.474 1.68l1.683 1.682a2.414 2.414 0 0 1 0 3.414L19.61 15.39a1 1 0 0 1-1.68-.474 2.5 2.5 0 1 0-3.014 3.015 1 1 0 0 1 .474 1.68l-1.683 1.682a2.414 2.414 0 0 1-3.414 0L8.61 19.61a1 1 0 0 0-1.68.474 2.5 2.5 0 1 1-3.014-3.015 1 1 0 0 0 .474-1.68l-1.683-1.682a2.414 2.414 0 0 1 0-3.414L4.39 8.61a1 1 0 0 1 1.68.474 2.5 2.5 0 1 0 3.014-3.015 1 1 0 0 1-.474-1.68l1.683-1.682a2.414 2.414 0 0 1 3.414 0z",key:"w46dr5"}]],lr=J("puzzle",kt),xt=/\.(jpe?g|png|webp|gif|bmp|avif)(?:$|[?#])/i,yt=/\.pdf(?:$|[?#])/i,wt=["{contractor}","{contractor_number}","{client_contractor_number}"];function g(...e){for(const t of e){const n=String(t??"").trim();if(n)return n}return""}function It(e){if(e&&typeof e=="object"&&!Array.isArray(e))return e;if(typeof e!="string")return null;try{const t=JSON.parse(e);return t&&typeof t=="object"&&!Array.isArray(t)?t:null}catch{return null}}function Nt(e="",t=""){const n=`${e} ${t}`;return xt.test(n)?"image":yt.test(n)?"pdf":"file"}function vt(e=""){const t=String(e||"").trim().toLowerCase();return t==="image"||t.startsWith("image/")}function St(e={}){var t,n,r;return g(e.date,e.messageDate,e.messageDateTime,e.createdAt,e.created,e.sentAt,e.receivedAt,e.timestamp,(t=e.message)==null?void 0:t.date,(n=e.message)==null?void 0:n.createdAt,(r=e.message)==null?void 0:r.sentAt)||null}function O(e){if(e==null||e==="")return null;const t=Number(e);return Number.isInteger(t)&&t>=0?t:null}function At(e,t){var i,u,m,l,c;if(!e||typeof e!="object"||Array.isArray(e))return null;const n=g(e.url,e.href,e.src,e.downloadUrl);if(!n)return null;const r=g(e.name,e.filename,e.fileName,e.title,decodeURIComponent(((i=String(n).split("/").pop())==null?void 0:i.split("?")[0])||""))||`Attachment ${t+1}`,o=g(e.type,e.contentType,e.mimeType),a=vt(o)?"image":Nt(r,n),s=g(e.messageId,e.messageID,e.postId,(u=e.message)==null?void 0:u.id)||null;return{id:g(e.id,e.attachmentId,e.documentId)||`${t}-${r}-${n}`,name:r,url:n,type:a,size:g(e.size,e.sizeText,e.fileSize)||null,messageId:s,postId:g(e.postId,s)||null,messageIndex:O(g(e.messageIndex,e.messageOrder,e.postIndex,(m=e.message)==null?void 0:m.index)),attachmentIndex:O(g(e.attachmentIndex,e.fileIndex)),messageAuthor:g(e.messageAuthor,e.author,e.createdBy,(l=e.message)==null?void 0:l.author,(c=e.message)==null?void 0:c.createdBy)||null,source:g(e.source,e.origin)||null,date:St(e)}}function xe(e){return String(e).padStart(2,"0")}function Ct(e){const t=e.getFullYear(),n=xe(e.getMonth()+1),r=xe(e.getDate());return{dateKey:`${t}-${n}-${r}`,label:`${r}.${n}.${t}`,sortValue:new Date(t,e.getMonth(),e.getDate()).getTime()}}function ye(e,t,n,r=0,o=0,a=0){if(t<0||t>11||n<1||n>31||r<0||r>23||o<0||o>59||a<0||a>59)return null;const s=new Date(e,t,n,r,o,a);return s.getFullYear()!==e||s.getMonth()!==t||s.getDate()!==n?null:s}function _t(e){if(e==null||e==="")return null;if(typeof e=="number"&&Number.isFinite(e)){const a=new Date(e);return Number.isNaN(a.getTime())?null:a}const t=String(e).trim();if(!t)return null;const n=t.match(/\b(\d{4})[./-](\d{1,2})[./-](\d{1,2})(?:[ T](\d{1,2}):(\d{2})(?::(\d{2}))?)?\b/);if(n){const a=ye(Number(n[1]),Number(n[2])-1,Number(n[3]),Number(n[4]||0),Number(n[5]||0),Number(n[6]||0));if(a)return a}const r=t.match(/\b(\d{1,2})([./-])(\d{1,2})\2(\d{2,4})(?:[ T](\d{1,2}):(\d{2})(?::(\d{2}))?)?\b/);if(r){const a=Number(r[1]),s=r[2],i=Number(r[3]),u=Number(r[4]),m=u<100?2e3+u:u,l=Number(r[5]||0),c=Number(r[6]||0),d=Number(r[7]||0),f=s==="/"&&i>12&&a<=12,b=f?i:a,k=(f?a:i)-1,y=ye(m,k,b,l,c,d);if(y)return y}const o=new Date(t);return Number.isNaN(o.getTime())?null:o}function le(e={}){const t=_t(e.date);return t?Ct(t):{dateKey:"unknown",label:"Date non disponible",sortValue:Number.NEGATIVE_INFINITY}}function Et(e,t){const n=g(t);n&&wt.forEach(r=>{e[r]=n})}function we(e){return!!(e&&typeof e=="object"&&!Array.isArray(e))}function Lt(e,t,n){const r=H(t),o=g(n);!r||!o||e.push([r,o])}function Oe(e,t=[]){const n=[];return we(e)&&Object.entries(e).forEach(([r,o])=>{if(we(o)){n.push(...Oe(o,[...t,r]));return}Lt(n,[...t,r].join("."),o)}),n}function Ot(e={}){const t={};return["tokenValues","values","variables","fields"].forEach(n=>{Oe(e[n]).forEach(([r,o])=>{t[r]=o})}),t}function G(e=[]){if(!Array.isArray(e))return[];const t=new Set;return e.map(At).filter(Boolean).filter(n=>{const r=`${n.name}|${n.url}`;return t.has(r)?!1:(t.add(r),!0)})}function z(e=[]){return G(e).filter(t=>t.type==="image")}function Dt(e=[]){const t=new Map;return z(e).forEach((n,r)=>{const o=le(n);t.has(o.dateKey)||t.set(o.dateKey,{...o,attachments:[]}),t.get(o.dateKey).attachments.push({...n,galleryIndex:r})}),Array.from(t.values()).sort((n,r)=>r.sortValue-n.sortValue)}function Ie(e={}){var t;return g(e.postId,e.messageId,e.messageID,(t=e.message)==null?void 0:t.id)}function Vt(e={},t=0){const n=O(e.messageNumber),r=O(e.messageIndex);return`Post ${n||(r===null?t+1:r+1)}`}function jt(e={}){const t=le(e),n=g(e.messageAuthor);return t.dateKey==="unknown"?n:[t.label,n].filter(Boolean).join(" · ")}function cr(e=[]){const t=z(e);if(!t.some(r=>Ie(r)))return Dt(t);const n=new Map;return t.forEach((r,o)=>{const a=Ie(r),s=le(r),i=a||`unassigned:${s.dateKey}`;if(!n.has(i)){const u=n.size;n.set(i,{dateKey:i,label:a?Vt(r,u):s.label,metaLabel:a?jt(r):"",sortValue:O(r.messageIndex)??o,attachments:[]})}n.get(i).attachments.push({...r,galleryIndex:o})}),Array.from(n.values()).sort((r,o)=>r.sortValue-o.sortValue)}function ur(e){var f,b;const t=It(e);if(!t)return{ok:!1,error:"INVALID_SUPER_OFFICE_JSON"};const n=g(t.ticketId,t.soTicket,t.soTicketNumber,t.ticketNumber),r=g(t.createdAt,t.created,t.createdDate,t.ticketCreatedAt,t.ticketCreatedDate),o=g(t.externalTicketId,t.externalId,t.externalID,t.hcampExternalId),a=g(t.contractorNumber,t.contractor,t.contractorNo,t.customerId,t.customer,(f=t.client)==null?void 0:f.contractorNumber,(b=t.client)==null?void 0:b.contractor),s={};let i=null,u=!1;const m=G(t.attachments),l=z(m);if(o){const k=Y(o);k.ok&&(u=!0,i=k.fields,Object.assign(s,re(k.fields)))}Object.assign(s,Ot(t));const c=(i==null?void 0:i.customer)||a;c&&(u||n||m.length>0)&&Et(s,c);const d=n||(i==null?void 0:i.soTicket)||"";return d&&(s[j]=d),Object.keys(s).length===0&&m.length===0?{ok:!1,error:"EMPTY_SUPER_OFFICE_DATA",externalIdValid:u,externalTicketId:o}:{ok:!0,ticketId:d,sourceTicketId:n,createdAt:r,externalTicketId:o,contractorNumber:c,externalIdValid:u,externalFields:i,tokenValues:s,attachments:m,imageAttachments:l,ignoredExternalId:!!(o&&!u)}}const ce="super_office_ticket_payload",ue="pending_super_office_ticket_payload",Ft="super-office-ticket-updated";function zt(e){if(!e||typeof e!="object"||Array.isArray(e))return e;const{[ae]:t,[ie]:n,...r}=e;return r}function W(e){return Array.isArray(e)?`[${e.map(W).join(",")}]`:e&&typeof e=="object"?`{${Object.keys(e).sort().map(t=>`${JSON.stringify(t)}:${W(e[t])}`).join(",")}}`:JSON.stringify(e)}function de(e=null){if(!e||typeof e!="object"||Array.isArray(e))return"";try{return W(zt(e))}catch{return""}}function D(e){typeof window>"u"||window.dispatchEvent(new CustomEvent(Ft,{detail:{payload:e}}))}function X(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=G(e.attachments),n=String(e.clientSignature||"").trim(),r=e.tokenValues&&typeof e.tokenValues=="object"&&!Array.isArray(e.tokenValues)?Object.fromEntries(Object.entries(e.tokenValues).map(([o,a])=>[o,a==null?"":String(a)])):{};return{ticketId:String(e.ticketId||"").trim(),sourceTicketId:String(e.sourceTicketId||"").trim(),createdAt:String(e.createdAt||e.created||e.createdDate||"").trim(),externalTicketId:String(e.externalTicketId||"").trim(),importedAt:e.importedAt||new Date().toISOString(),clientSignature:n,tokenValues:r,attachments:t,imageAttachments:z(t)}}function Mt(e,t=new Date,n=""){return X({ticketId:(e==null?void 0:e.ticketId)||"",sourceTicketId:(e==null?void 0:e.sourceTicketId)||"",createdAt:(e==null?void 0:e.createdAt)||"",externalTicketId:(e==null?void 0:e.externalTicketId)||"",importedAt:t.toISOString(),clientSignature:n,tokenValues:(e==null?void 0:e.tokenValues)||{},attachments:(e==null?void 0:e.attachments)||[]})}async function me(e){e&&await _e(ce,e)}async function De(e){e&&await _e(ue,e)}async function Z(){try{return X(await Ae(ue,null))}catch(e){return console.error("loadPendingSuperOfficeTicketPayload error",e),null}}function dr(){return Z()}async function $t(){return await Ve()||await Z()}async function mr(){return!!await $t()}function pe(){return Ce(ue)}async function pr(e){const t=await oe(),n=Mt(e,new Date,de(t));return n?n.clientSignature?(await me(n),await pe(),D(n),n):(await K(),await De(n),D(null),n):null}async function fr(e){const t=dt(e);if(!t)return null;const n=await Ve(),r=n?null:await Z(),o=n||r;if(!o)return null;const a=Y(t),s=a.ok?{...o.tokenValues||{},...re(a.fields)}:o.tokenValues||{},i=X({...o,externalTicketId:t,tokenValues:s});return i?(i.clientSignature?await me(i):await De(i),D(i),i):null}function K(){return Ce(ce)}async function br(){const e=await Z(),t=de(await oe());if(!e||!t)return null;const n={...e,clientSignature:t};return await me(n),await pe(),D(n),n}async function Ve(){try{const e=await Ae(ce,null);if(!e)return null;const t=de(await oe());if(!t)return await K(),null;if((e==null?void 0:e.clientSignature)!==t)return await K(),null;const n=X(e);return n||null}catch(e){return console.error("loadSuperOfficeTicketPayload error",e),null}}async function hr(){await K(),await pe(),D(null)}const je="quick_tools",Bt="blue",A=Object.freeze({LINK:"link",MODULE:"module"}),Rt=A.LINK,Ut=[{value:"blue",label:"Blue"},{value:"cyan",label:"Cyan"},{value:"emerald",label:"Green"},{value:"amber",label:"Amber"},{value:"rose",label:"Rose"},{value:"violet",label:"Violet"},{value:"slate",label:"Slate"}],Kt=new Set(Ut.map(e=>e.value)),qt=new Set(Object.values(A));function Pt(e){return Kt.has(e)?e:Bt}function Fe(e){return qt.has(e)?e:Rt}function Jt(e){const t=Number(e);return Number.isFinite(t)?t:void 0}function ze(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=e.type||(e.html?A.MODULE:A.LINK),n=Fe(t);return{...e,type:n,title:String(e.title||"").trim(),url:n===A.LINK?String(e.url||"").trim():"",description:String(e.description||"").trim(),prompt:String(e.prompt||""),html:String(e.html||""),color:Pt(e.color),order:Jt(e.order),beta:n===A.MODULE?!0:!!e.beta}}async function gr(){const e=await pt(je,[]);return Array.isArray(e)?e.map(ze).filter(Boolean):[]}async function Tr(e){const t=Array.isArray(e)?e.map(ze).filter(Boolean):[];return ft(je,t)}function kr(e,t={}){return(e||"").replace(/\{[^}]+\}/g,n=>{const r=t[n];if(r==null||r==="")return n;const o=String(r).replace(/<[^>]+>/g,"").trim();return encodeURIComponent(o)})}function xr(e){return Fe(e==null?void 0:e.type)===A.MODULE}const Yt=new Set(["title","description","channels","contentByChannel","favorite","nodeIds","parentNodeId","order"]);function fe(e){return e==null?e:JSON.parse(JSON.stringify(e))}function L(e){return Array.isArray(e)?e:e==null||e===""?[]:[e]}function C(e=""){return String(e||"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}function Me(e=[]){return new Map(e.map(t=>[t.id,t]))}function $e(e,t){if(!e)return"";const n=[],r=new Set;let o=e;for(;o&&!r.has(o.id);)r.add(o.id),n.unshift(o.title||o.id),o=o.parentId?t.get(o.parentId):null;return n.join(" / ")}function Ht(e=[]){const t=Me(e);return e.map(n=>({...n,path:$e(n,t)}))}function Be(e=[],t){const n=String(t||"").trim();if(!n)return null;const r=Me(e);if(r.has(n))return r.get(n);const o=C(n);return e.find(a=>C(a.title)===o||C($e(a,r))===o)||null}function Gt(e=[],t={}){return Be(e,t.fromNodeId||t.sourceNodeId||t.fromTopicId||t.sourceTopicId||t.fromNode||t.sourceNode||t.fromTopic||t.sourceTopic)}function Xt(e=[],t={}){return Be(e,t.toNodeId||t.targetNodeId||t.toTopicId||t.targetTopicId||t.toNode||t.targetNode||t.toTopic||t.targetTopic)}function Zt(e,t={},n=null){const r=L(t.templateIds||t.templateId).map(String).filter(Boolean);if(r.length>0&&!r.includes(e.id)||n&&!(e.nodeIds||[]).includes(n.id))return!1;const o=L(t.channels||t.channel).map(i=>String(i||"").trim()).filter(Boolean);if(o.length>0&&!o.some(i=>(e.channels||[]).includes(i)))return!1;const a=String(t.title||t.templateTitle||"").trim();if(a&&C(e.title)!==C(a))return!1;const s=L(t.titleIncludes||t.templateTitleIncludes).map(C).filter(Boolean);if(s.length>0){const i=C(e.title);if(!s.some(u=>i.includes(u)))return!1}return!0}function Wt({template:e,sourceNode:t,targetNode:n,reason:r=""}){return{action:"moveTemplate",templateId:e.id,templateTitle:e.title||"",sourceNodeId:(t==null?void 0:t.id)||null,sourceNodeTitle:(t==null?void 0:t.title)||"",targetNodeId:n.id,targetNodeTitle:n.title||"",reason:r}}function Re({nodes:e=[],templates:t=[]}={}){return{nodes:Ht(e),templates:fe(t),counts:{nodes:e.length,templates:t.length}}}function Ue(e={}){if(!e||typeof e!="object"||Array.isArray(e))throw new Error("Template patch must be an object.");const t={};return Object.entries(e).forEach(([n,r])=>{Yt.has(n)&&(t[n]=r)}),t}async function Ke(){return Re(await F())}async function Qt(){return Ke()}async function en(e=[]){const t=L(e),{nodes:n,templates:r}=await F(),o=[],a=[];return t.forEach((s,i)=>{if(!s||typeof s!="object"||Array.isArray(s)){a.push({ruleIndex:i,reason:"Rule must be an object."});return}const u=Xt(n,s);if(!u){a.push({ruleIndex:i,reason:"Target topic was not found."});return}const m=Gt(n,s),l=r.filter(c=>Zt(c,s,m));if(l.length===0){a.push({ruleIndex:i,reason:"No templates matched this rule."});return}l.forEach(c=>{(c.nodeIds||[])[0]===u.id&&(!m||m.id===u.id)||o.push(Wt({template:c,sourceNode:m,targetNode:u,reason:s.reason||`Rule ${i+1}`}))})}),{ok:!0,ruleCount:t.length,operationCount:o.length,affectedTemplateCount:new Set(o.map(s=>s.templateId)).size,operations:o,skipped:a}}async function tn(e=[]){const t=L(e),n=await F();let r=n.nodes,o=n.templates;const a=[],s=[];return t.forEach((i,u)=>{var l;const m=(i==null?void 0:i.action)||(i==null?void 0:i.type);if(!i||typeof i!="object"||Array.isArray(i)){s.push({operationIndex:u,reason:"Operation must be an object."});return}if(m==="moveTemplate"){const c=String(i.templateId||""),d=String(i.targetNodeId||i.toNodeId||"");if(!c||!d){s.push({operationIndex:u,reason:"moveTemplate requires templateId and targetNodeId."});return}const f=o.find(y=>y.id===c),b=i.sourceNodeId||((l=f==null?void 0:f.nodeIds)==null?void 0:l[0])||null,k=JSON.stringify(o);o=Ee(o,c,b,d,Number(i.targetIndex),r),JSON.stringify(o)!==k&&a.push({operationIndex:u,action:m,templateId:c,targetNodeId:d});return}if(m==="updateTemplate"){const c=String(i.templateId||"");if(!c){s.push({operationIndex:u,reason:"updateTemplate requires templateId."});return}const d=Ue(i.patch||i.fields||{}),f=JSON.stringify(o);o=Le(o,c,d),JSON.stringify(o)!==f&&a.push({operationIndex:u,action:m,templateId:c});return}s.push({operationIndex:u,reason:`Unsupported operation: ${m||"unknown"}.`})}),a.length>0&&await se({nodes:r,templates:o}),{ok:!0,appliedCount:a.length,skippedCount:s.length,applied:a,skipped:s,tree:Re({nodes:r,templates:o})}}async function nn(e,t={}){const n=String(e||"");if(!n)throw new Error("templateId is required.");const r=await F();if(!r.templates.some(a=>a.id===n))throw new Error("Template was not found.");const o=Le(r.templates,n,Ue(t));return await se({nodes:r.nodes,templates:o}),{ok:!0,template:fe(o.find(a=>a.id===n))}}async function rn(e,t,n={}){var m;const r=String(e||""),o=String(t||"");if(!r||!o)throw new Error("templateId and targetNodeId are required.");const a=await F();if(!a.templates.some(l=>l.id===r))throw new Error("Template was not found.");const s=a.templates.find(l=>l.id===r),i=(n==null?void 0:n.sourceNodeId)||((m=s==null?void 0:s.nodeIds)==null?void 0:m[0])||null,u=Ee(a.templates,r,i,o,Number(n==null?void 0:n.targetIndex),a.nodes);return await se({nodes:a.nodes,templates:u}),{ok:!0,template:fe(bt(u.find(l=>l.id===r)))}}async function yr(e,t={}){switch(e){case"tool:templates:list":return Ke();case"tool:templates:get-tree":return Qt();case"tool:templates:preview-migration":return en(t.rules||t);case"tool:templates:apply-migration":return tn(t.operations||t);case"tool:templates:update-template":return nn(t.templateId,t.patch||t.fields||{});case"tool:templates:move-template":return rn(t.templateId,t.targetNodeId,t.options||{});default:throw new Error("Unsupported template module request.")}}const q="template-tool-module-beta-1",qe=Object.freeze({name:"Template Generator Module API",version:q,globals:{TemplateTool:{type:"object",description:"Host bridge used by module JavaScript to read data, copy content, show feedback and control the module modal."},TemplateVars:{type:"object",description:"Runtime variables with safe JavaScript property names, populated after TemplateTool.getContext()."},TemplateProfile:{type:"object",description:"Normalized customer profile with easy fields, variables, tokens, photos and attachments."},TemplateEnv:{type:"object",description:"Execution metadata for the current module."},TemplateFields:{type:"array",description:"Normalized visible fields available to the module."},TemplateContext:{type:"object",description:"Full runtime context returned by TemplateTool.getContext()."},TemplateAPI:{type:"object",description:"Static API reference exposed inside every module."}},variables:{access:"await TemplateTool.getContext(); then read window.TemplateVars",examples:["TemplateVars.clientName","TemplateVars.mobile","TemplateVars.contractor","TemplateVars.activationDate","TemplateVars.otoId","TemplateVars.soTicketNum","TemplateVars.byToken['{client_first_name}']","TemplateVars.byKey['client.firstName']","TemplateVars.byLabel['Full name']"],reservedContainers:["env","raw","byToken","byKey","byLabel"]},contextShape:{apiVersion:"string",tool:"{ id: string, title: string, description: string }",environment:"{ apiVersion, toolId, toolTitle, toolDescription, generatedAt }",profile:"normalized customer profile with fields, vars, tokenValues, photos and attachments",variables:"TemplateVars object",values:"token values plus compatibility aliases",tokenValues:"original token-keyed values",tokens:"Array<{ token, label, key, inputType, value, internal, aliases }>",fields:"Array<{ label, value, source, token, key, section, aliases }>",fieldIndex:"normalized lookup object",client:"raw imported client payload or null",clientInfo:"visible client detail sections",clientSummary:"compact client bar fields",generatedAt:"ISO timestamp"},functions:{"TemplateTool.getContext()":"Promise<TemplateContext>","TemplateTool.getProfile()":"Promise<TemplateProfile>","TemplateTool.getVars()":"Promise<TemplateVars>","TemplateTool.getVar(name, fallback = '')":"Promise<string>","TemplateTool.hasVariable(name)":"Promise<boolean>","TemplateTool.listVariables()":"Promise<string[]>","TemplateTool.findField(candidates)":"Promise<Field|null>","TemplateTool.getFieldValue(candidates, fallback = '')":"Promise<string>","TemplateTool.templates.list()":"Promise<{ nodes, templates, counts }>","TemplateTool.templates.getTree()":"Promise<{ nodes, templates, counts }>","TemplateTool.templates.previewMigration(rules)":"Promise<{ operations, skipped, operationCount, affectedTemplateCount }>","TemplateTool.templates.applyMigration(operations)":"Promise<{ ok, appliedCount, skippedCount, tree }>","TemplateTool.templates.updateTemplate(templateId, patch)":"Promise<{ ok, template }>","TemplateTool.templates.moveTemplate(templateId, targetNodeId, options = {})":"Promise<{ ok, template }>","TemplateTool.copyText(text, message)":"Promise<{ ok: boolean }>","TemplateTool.copyHtml(html, message)":"Promise<{ ok: boolean }>","TemplateTool.toast(message, variant)":"Promise<{ ok: boolean }>","TemplateTool.openUrl(url)":"Promise<{ ok: boolean }>","TemplateTool.close()":"void","TemplateTool.requestResize()":"void","TemplateTool.onContext(callback)":"unsubscribe function","TemplateTool.describeApi()":"TemplateAPI reference"}});function on(e=qe){const t=[`${e.name} (${e.version})`,"","Globals:"];return Object.entries(e.globals||{}).forEach(([n,r])=>{t.push(`- window.${n}: ${r.description}`)}),t.push("","Variable access:",`- ${e.variables.access}`),(e.variables.examples||[]).forEach(n=>{t.push(`- ${n}`)}),t.push(`- Reserved TemplateVars containers: ${(e.variables.reservedContainers||[]).join(", ")}`),t.push("","Context shape:"),Object.entries(e.contextShape||{}).forEach(([n,r])=>{t.push(`- ${n}: ${r}`)}),t.push("","Functions:"),Object.entries(e.functions||{}).forEach(([n,r])=>{t.push(`- ${n}: ${r}`)}),t.join(`
`)}const an=`
...
</html>`:ln}function dn(e,t,n){return e.includes(n)?e:/<\/head\s*>/i.test(e)?e.replace(/<\/head\s*>/i,`${t}</head>`):/<head[\s>]/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>${t}`):/<html[\s>]/i.test(e)?e.replace(/<html([^>]*)>/i,`<html$1>${t}`):`${t}${e}`}function mn(e,t,n){return e.includes(n)?e:/<head[\s>]/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>${t}`):/<html[\s>]/i.test(e)?e.replace(/<html([^>]*)>/i,`<html$1>${t}`):`${t}${e}`}function wr(e=""){const t=un(e),n=mn(t,sn,"template-tool-bridge");return dn(n,an,"template-tool-host-style")}function pn(e=[],t={}){return Array.isArray(e)?e.filter(n=>n==null?void 0:n.token).map(n=>{const r=Object.prototype.hasOwnProperty.call(t,n.token)?t[n.token]:n.previewValue;return{token:n.token,label:n.label||n.token,key:n.key||"",inputType:n.input_type||n.inputType||"text",value:r??"",internal:!!n.internal,aliases:Array.isArray(n.searchAliases)?n.searchAliases.filter(Boolean):[]}}):[]}function V(e){return e==null?"":typeof e=="string"?e.trim():typeof e=="number"||typeof e=="boolean"?String(e):""}function Q(e=""){return String(e||"").replace(/[{}]/g,"").replace(/([a-z0-9])([A-Z])/g,"$1 $2").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/&/g,"and").replace(/[^a-z0-9]+/g,"")}function Pe(e=""){return String(e||"").replace(/[{}]/g,"").replace(/([a-z0-9])([A-Z])/g,"$1 $2").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/&/g,"and").replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}function Je(e=""){const t=Pe(e);return t?t.replace(/_([a-z0-9])/g,(n,r)=>r.toUpperCase()):""}function Ye(e=""){const t=Je(e);return t?/^[A-Za-z_$]/.test(t)?t:`field${t.charAt(0).toUpperCase()}${t.slice(1)}`:""}function be(e=""){return String(e||"").split(".").map(t=>t.trim()).filter(Boolean)}function M(e,t){const n=String(t||"").trim();!n||e.includes(n)||e.push(n)}function N(e,t){const n=String(t||"").trim();if(!n)return;M(e,n);const r=Pe(n),o=Je(n);r&&(M(e,r),M(e,`{${r}}`)),o&&M(e,o)}function fn({label:e="",token:t="",key:n="",aliases:r=[],section:o=""}={}){const a=[];N(a,e),N(a,t),N(a,t.replace(/[{}]/g,"")),N(a,n);const s=be(n);return s.length>0&&(N(a,s[s.length-1]),N(a,s.join(" ")),N(a,s.join(""))),N(a,o),r.forEach(i=>N(a,i)),a}function bn(e){const t=V(e.value);if(t==="")return null;const n={label:String(e.label||e.token||e.key||"Field"),value:t,source:e.source||"context"};return e.token&&(n.token=String(e.token)),e.key&&(n.key=String(e.key)),e.section&&(n.section=String(e.section)),n.aliases=fn({...e,...n}),n}function hn({tokens:e=[],clientInfo:t=[],clientSummary:n=[],profile:r=null}={}){const o=[],a=new Set,s=i=>{const u=bn(i);if(!u)return;const m=`${u.source}:${u.label}:${u.value}:${u.token||""}:${u.key||""}`;a.has(m)||(a.add(m),o.push(u))};return e.forEach(i=>{s({label:i.label,value:i.value,token:i.token,key:i.key,aliases:i.aliases,source:"token"})}),n.forEach(i=>{s({label:i.label,value:i.value,section:"summary",source:"clientSummary"})}),t.forEach(i=>{((i==null?void 0:i.fields)||[]).forEach(u=>{s({label:u.label,value:u.value,section:i.title||i.id,source:"clientInfo"})})}),r&&typeof r=="object"&&(Array.isArray(r.availableFields)?r.availableFields:[]).forEach(i=>{s({label:i.label,value:i.value,key:i.key,aliases:i.aliases,source:"profile"})}),o}function gn(e,t,n){!t||n===""||Object.prototype.hasOwnProperty.call(e,t)||(e[t]=n)}function Tn(e,t,n){const r=be(t);if(r.length<2||n==="")return;let o=e;for(let s=0;s<r.length-1;s+=1){const i=r[s];if(!i||/^\d+$/.test(i)||(o[i]===void 0&&(o[i]={}),!o[i]||typeof o[i]!="object"||Array.isArray(o[i])))return;o=o[i]}const a=r[r.length-1];a&&!Object.prototype.hasOwnProperty.call(o,a)&&(o[a]=n)}function kn(e={},t=[]){const n={...e};return t.forEach(r=>{r.key&&Tn(n,r.key,r.value),r.aliases.forEach(o=>gn(n,o,r.value))}),He(n,t),n}const xn=Object.freeze([{name:"clientName",candidates:["clientName","client name","fullName","full name","name","client.name"]}]);function yn(e,t){const n=Q(t);return!e||!n?!1:[e.label,e.token,e.key,...e.aliases||[]].some(r=>Q(r)===n)}function wn(e=[],t=[]){for(const n of t){const r=e.find(a=>yn(a,n)),o=V(r==null?void 0:r.value);if(o!=="")return o}return""}function He(e,t=[]){xn.forEach(({name:n,candidates:r})=>{if(Object.prototype.hasOwnProperty.call(e,n))return;const o=wn(t,r);o!==""&&(e[n]=o)})}function In(e=[]){const t={};return e.forEach(n=>{[n.label,n.token,n.key,...n.aliases||[]].forEach(r=>{const o=Q(r);!o||t[o]||(t[o]={label:n.label,value:n.value,source:n.source,token:n.token||"",key:n.key||"",section:n.section||""})})}),t}function U(e,t,n){const r=Ye(t);!r||n===""||Object.prototype.hasOwnProperty.call(e,r)||(e[r]=n)}function Nn(e,t,n){const r=be(t).map(Ye).filter(Boolean);if(r.length<2||n==="")return;let o=e;for(let s=0;s<r.length-1;s+=1){const i=r[s];if(o[i]===void 0&&(o[i]={}),!o[i]||typeof o[i]!="object"||Array.isArray(o[i]))return;o=o[i]}const a=r[r.length-1];a&&!Object.prototype.hasOwnProperty.call(o,a)&&(o[a]=n)}function vn(e,t=null){if(!t||typeof t!="object")return;const n=t.vars&&typeof t.vars=="object"?t.vars:t.variables&&typeof t.variables=="object"?t.variables:{};Object.entries(n).forEach(([r,o])=>{const a=V(o);a!==""&&U(e,r,a)})}function Sn({fields:e=[],tokenValues:t={},environment:n={},profile:r=null}={}){const o={env:n,raw:t,byToken:{},byKey:{},byLabel:{}};return Object.entries(t||{}).forEach(([a,s])=>{const i=V(s);i!==""&&(o.byToken[a]=i,U(o,a,i),U(o,a.replace(/[{}]/g,""),i))}),vn(o,r),e.forEach(a=>{const s=V(a.value);s!==""&&(a.token&&(o.byToken[a.token]=s),a.key&&(o.byKey[a.key]=s,Nn(o,a.key,s)),o.byLabel[a.label]=s,[a.label,a.token,a.key,...a.aliases||[]].forEach(i=>{U(o,i,s)}))}),He(o,e),o}function Ir({tool:e={},values:t={},tokens:n=[],client:r=null,clientInfo:o=[],clientSummary:a=[],profile:s=null}={}){const i=t&&typeof t=="object"?t:{},u=s&&typeof s=="object"?s:null,m=u!=null&&u.tokenValues&&typeof u.tokenValues=="object"?u.tokenValues:{},l={...i,...m},c=Array.isArray(o)?o:[],d=Array.isArray(a)?a:[],f=pn(n,l),b=hn({tokens:f,clientInfo:c,clientSummary:d,profile:u}),k=new Date().toISOString(),y={apiVersion:q,toolId:e.id||"",toolTitle:e.title||"",toolDescription:e.description||"",generatedAt:k};return{apiVersion:q,tool:{id:e.id||"",title:e.title||"",description:e.description||""},profile:u||null,values:kn(l,b),tokenValues:l,tokens:f,fields:b,fieldIndex:In(b),variables:Sn({fields:b,tokenValues:l,environment:y,profile:u}),environment:y,client:r&&typeof r=="object"?r:null,clientInfo:c,clientSummary:d,generatedAt:k}}function An(e=""){const t=String(e||"").trim(),n=t.match(/^```(?:json|text)?\s*([\s\S]*?)\s*```$/i);return n?n[1].trim():t}function Nr(e=""){const t=An(e);if(!t)return"";try{const n=JSON.parse(t);return n&&typeof n=="object"&&!Array.isArray(n)&&typeof n.html=="string"&&n.html.trim()?n.html.trim():""}catch{return""}}function vr({title:e="",prompt:t=""}={}){const n=String(e||"").trim()||"Custom tool",r=String(t||"").trim()||"Create a useful workflow tool for my Template Generator app.";return`You are building a custom Beta module for a local app called Template Generator.
