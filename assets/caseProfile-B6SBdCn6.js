import{c as L}from"./createLucideIcon-Bd_u7N26.js";import{v as G,P as pe,S as D,w as he,h as Z,u as ge,Q as X,R as W,K as Te,B as Q,T as qe}from"./tokenService-BgQbM85i.js";import{l as Pe,a as Ye}from"./index-B_op4jem.js";/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const He=[["path",{d:"m15 18-6-6 6-6",key:"1wnfg3"}]],yn=L("chevron-left",He);/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Je=[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]],wn=L("chevron-right",Je);/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ge=[["rect",{width:"8",height:"4",x:"8",y:"2",rx:"1",ry:"1",key:"tgr4d6"}],["path",{d:"M8 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2",key:"4jdomd"}],["path",{d:"M16 4h2a2 2 0 0 1 2 2v4",key:"3hqy98"}],["path",{d:"M21 14H11",key:"1bme5i"}],["path",{d:"m15 10-4 4 4 4",key:"5dvupr"}]],In=L("clipboard-copy",Ge);/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ze=[["path",{d:"M15 3h6v6",key:"1q9fwt"}],["path",{d:"M10 14 21 3",key:"gplh6r"}],["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}]],vn=L("external-link",Ze);/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xe=[["path",{d:"M15.39 4.39a1 1 0 0 0 1.68-.474 2.5 2.5 0 1 1 3.014 3.015 1 1 0 0 0-.474 1.68l1.683 1.682a2.414 2.414 0 0 1 0 3.414L19.61 15.39a1 1 0 0 1-1.68-.474 2.5 2.5 0 1 0-3.014 3.015 1 1 0 0 1 .474 1.68l-1.683 1.682a2.414 2.414 0 0 1-3.414 0L8.61 19.61a1 1 0 0 0-1.68.474 2.5 2.5 0 1 1-3.014-3.015 1 1 0 0 0 .474-1.68l-1.683-1.682a2.414 2.414 0 0 1 0-3.414L4.39 8.61a1 1 0 0 1 1.68.474 2.5 2.5 0 1 0 3.014-3.015 1 1 0 0 1-.474-1.68l1.683-1.682a2.414 2.414 0 0 1 3.414 0z",key:"w46dr5"}]],Nn=L("puzzle",Xe),We=/\.(jpe?g|png|webp|gif|bmp|avif)(?:$|[?#])/i,Qe=/\.pdf(?:$|[?#])/i,et=["{contractor}","{contractor_number}","{client_contractor_number}"];function w(...e){for(const t of e){const n=String(t??"").trim();if(n)return n}return""}function tt(e){if(e&&typeof e=="object"&&!Array.isArray(e))return e;if(typeof e!="string")return null;try{const t=JSON.parse(e);return t&&typeof t=="object"&&!Array.isArray(t)?t:null}catch{return null}}function nt(e="",t=""){const n=`${e} ${t}`;return We.test(n)?"image":Qe.test(n)?"pdf":"file"}function rt(e=""){const t=String(e||"").trim().toLowerCase();return t==="image"||t.startsWith("image/")}function ot(e={}){var t,n,r;return w(e.date,e.messageDate,e.messageDateTime,e.createdAt,e.created,e.sentAt,e.receivedAt,e.timestamp,(t=e.message)==null?void 0:t.date,(n=e.message)==null?void 0:n.createdAt,(r=e.message)==null?void 0:r.sentAt)||null}function at(e,t){var s,i;if(!e||typeof e!="object"||Array.isArray(e))return null;const n=w(e.url,e.href,e.src,e.downloadUrl);if(!n)return null;const r=w(e.name,e.filename,e.fileName,e.title,decodeURIComponent(((s=String(n).split("/").pop())==null?void 0:s.split("?")[0])||""))||`Attachment ${t+1}`,o=w(e.type,e.contentType,e.mimeType),a=rt(o)?"image":nt(r,n);return{id:w(e.id,e.attachmentId,e.documentId)||`${t}-${r}-${n}`,name:r,url:n,type:a,size:w(e.size,e.sizeText,e.fileSize)||null,messageId:w(e.messageId,e.messageID,(i=e.message)==null?void 0:i.id)||null,date:ot(e)}}function de(e){return String(e).padStart(2,"0")}function it(e){const t=e.getFullYear(),n=de(e.getMonth()+1),r=de(e.getDate());return{dateKey:`${t}-${n}-${r}`,label:`${r}.${n}.${t}`,sortValue:new Date(t,e.getMonth(),e.getDate()).getTime()}}function st(e){if(e==null||e==="")return null;if(typeof e=="number"&&Number.isFinite(e)){const a=new Date(e);return Number.isNaN(a.getTime())?null:a}const t=String(e).trim();if(!t)return null;const n=t.match(/\b(\d{1,2})[./-](\d{1,2})[./-](\d{2,4})\b/);if(n){const a=Number(n[1]),s=Number(n[2])-1,i=Number(n[3]),u=i<100?2e3+i:i,f=new Date(u,s,a);if(!Number.isNaN(f.getTime()))return f}const r=t.match(/\b(\d{4})[./-](\d{1,2})[./-](\d{1,2})\b/);if(r){const a=new Date(Number(r[1]),Number(r[2])-1,Number(r[3]));if(!Number.isNaN(a.getTime()))return a}const o=new Date(t);return Number.isNaN(o.getTime())?null:o}function lt(e={}){const t=st(e.date);return t?it(t):{dateKey:"unknown",label:"Date non disponible",sortValue:Number.NEGATIVE_INFINITY}}function ct(e,t){const n=w(t);n&&et.forEach(r=>{e[r]=n})}function K(e=[]){if(!Array.isArray(e))return[];const t=new Set;return e.map(at).filter(Boolean).filter(n=>{const r=`${n.name}|${n.url}`;return t.has(r)?!1:(t.add(r),!0)})}function U(e=[]){return K(e).filter(t=>t.type==="image")}function Sn(e=[]){const t=new Map;return U(e).forEach((n,r)=>{const o=lt(n);t.has(o.dateKey)||t.set(o.dateKey,{...o,attachments:[]}),t.get(o.dateKey).attachments.push({...n,galleryIndex:r})}),Array.from(t.values()).sort((n,r)=>r.sortValue-n.sortValue)}function _n(e){var p,b;const t=tt(e);if(!t)return{ok:!1,error:"INVALID_SUPER_OFFICE_JSON"};const n=w(t.ticketId,t.soTicket,t.soTicketNumber,t.ticketNumber),r=w(t.createdAt,t.created,t.createdDate,t.ticketCreatedAt,t.ticketCreatedDate),o=w(t.externalTicketId,t.externalId,t.externalID,t.hcampExternalId),a=w(t.contractorNumber,t.contractor,t.contractorNo,t.customerId,t.customer,(p=t.client)==null?void 0:p.contractorNumber,(b=t.client)==null?void 0:b.contractor),s={};let i=null,u=!1;const f=K(t.attachments),l=U(f);if(o){const y=G(o);y.ok&&(u=!0,i=y.fields,Object.assign(s,pe(y.fields)))}const c=(i==null?void 0:i.customer)||a;c&&(u||n||f.length>0)&&ct(s,c);const d=n||(i==null?void 0:i.soTicket)||"";return d&&(s[D]=d),Object.keys(s).length===0&&f.length===0?{ok:!1,error:"EMPTY_SUPER_OFFICE_DATA",externalIdValid:u,externalTicketId:o}:{ok:!0,ticketId:d,sourceTicketId:n,createdAt:r,externalTicketId:o,contractorNumber:c,externalIdValid:u,externalFields:i,tokenValues:s,attachments:f,imageAttachments:l,ignoredExternalId:!!(o&&!u)}}const ee="super_office_ticket_payload",te="pending_super_office_ticket_payload",ut="super-office-ticket-updated";function dt(e){if(!e||typeof e!="object"||Array.isArray(e))return e;const{[X]:t,[W]:n,...r}=e;return r}function q(e){return Array.isArray(e)?`[${e.map(q).join(",")}]`:e&&typeof e=="object"?`{${Object.keys(e).sort().map(t=>`${JSON.stringify(t)}:${q(e[t])}`).join(",")}}`:JSON.stringify(e)}function ne(e=null){if(!e||typeof e!="object"||Array.isArray(e))return"";try{return q(dt(e))}catch{return""}}function z(e){typeof window>"u"||window.dispatchEvent(new CustomEvent(ut,{detail:{payload:e}}))}function re(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=K(e.attachments),n=String(e.clientSignature||"").trim(),r=e.tokenValues&&typeof e.tokenValues=="object"&&!Array.isArray(e.tokenValues)?Object.fromEntries(Object.entries(e.tokenValues).map(([o,a])=>[o,a==null?"":String(a)])):{};return{ticketId:String(e.ticketId||"").trim(),sourceTicketId:String(e.sourceTicketId||"").trim(),createdAt:String(e.createdAt||e.created||e.createdDate||"").trim(),externalTicketId:String(e.externalTicketId||"").trim(),importedAt:e.importedAt||new Date().toISOString(),clientSignature:n,tokenValues:r,attachments:t,imageAttachments:U(t)}}function mt(e,t=new Date,n=""){return re({ticketId:(e==null?void 0:e.ticketId)||"",sourceTicketId:(e==null?void 0:e.sourceTicketId)||"",createdAt:(e==null?void 0:e.createdAt)||"",externalTicketId:(e==null?void 0:e.externalTicketId)||"",importedAt:t.toISOString(),clientSignature:n,tokenValues:(e==null?void 0:e.tokenValues)||{},attachments:(e==null?void 0:e.attachments)||[]})}async function xe(e){e&&await Te(ee,e)}async function ft(e){e&&await Te(te,e)}async function oe(){try{return re(await he(te,null))}catch(e){return console.error("loadPendingSuperOfficeTicketPayload error",e),null}}function Cn(){return oe()}async function bt(){return await pt()||await oe()}async function An(){return!!await bt()}function ae(){return ge(te)}async function En(e){const t=await Z(),n=mt(e,new Date,ne(t));return n?n.clientSignature?(await xe(n),await ae(),z(n),n):(await B(),await ft(n),z(null),n):null}function B(){return ge(ee)}async function Ln(){const e=await oe(),t=ne(await Z());if(!e||!t)return null;const n={...e,clientSignature:t};return await xe(n),await ae(),z(n),n}async function pt(){try{const e=await he(ee,null);if(!e)return null;const t=ne(await Z());if(!t)return await B(),null;if((e==null?void 0:e.clientSignature)!==t)return await B(),null;const n=re(e);return n||null}catch(e){return console.error("loadSuperOfficeTicketPayload error",e),null}}async function Dn(){await B(),await ae(),z(null)}const ke="quick_tools",ht="blue",_=Object.freeze({LINK:"link",MODULE:"module"}),gt=_.LINK,Tt=[{value:"blue",label:"Blue"},{value:"cyan",label:"Cyan"},{value:"emerald",label:"Green"},{value:"amber",label:"Amber"},{value:"rose",label:"Rose"},{value:"violet",label:"Violet"},{value:"slate",label:"Slate"}],xt=new Set(Tt.map(e=>e.value)),kt=new Set(Object.values(_));function yt(e){return xt.has(e)?e:ht}function ye(e){return kt.has(e)?e:gt}function wt(e){const t=Number(e);return Number.isFinite(t)?t:void 0}function we(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=e.type||(e.html?_.MODULE:_.LINK),n=ye(t);return{...e,type:n,title:String(e.title||"").trim(),url:n===_.LINK?String(e.url||"").trim():"",description:String(e.description||"").trim(),prompt:String(e.prompt||""),html:String(e.html||""),color:yt(e.color),order:wt(e.order),beta:n===_.MODULE?!0:!!e.beta}}async function On(){const e=await Pe(ke,[]);return Array.isArray(e)?e.map(we).filter(Boolean):[]}async function Vn(e){const t=Array.isArray(e)?e.map(we).filter(Boolean):[];return Ye(ke,t)}function jn(e,t={}){return(e||"").replace(/\{[^}]+\}/g,n=>{const r=t[n];if(r==null||r==="")return n;const o=String(r).replace(/<[^>]+>/g,"").trim();return encodeURIComponent(o)})}function Fn(e){return ye(e==null?void 0:e.type)===_.MODULE}const R="template-tool-module-beta-1",Ie=Object.freeze({name:"Template Generator Module API",version:R,globals:{TemplateTool:{type:"object",description:"Host bridge used by module JavaScript to read data, copy content, show feedback and control the module modal."},TemplateVars:{type:"object",description:"Runtime variables with safe JavaScript property names, populated after TemplateTool.getContext()."},TemplateProfile:{type:"object",description:"Normalized customer profile with easy fields, variables, tokens, photos and attachments."},TemplateEnv:{type:"object",description:"Execution metadata for the current module."},TemplateFields:{type:"array",description:"Normalized visible fields available to the module."},TemplateContext:{type:"object",description:"Full runtime context returned by TemplateTool.getContext()."},TemplateAPI:{type:"object",description:"Static API reference exposed inside every module."}},variables:{access:"await TemplateTool.getContext(); then read window.TemplateVars",examples:["TemplateVars.clientName","TemplateVars.mobile","TemplateVars.contractor","TemplateVars.activationDate","TemplateVars.otoId","TemplateVars.soTicketNum","TemplateVars.byToken['{client_first_name}']","TemplateVars.byKey['client.firstName']","TemplateVars.byLabel['Full name']"],reservedContainers:["env","raw","byToken","byKey","byLabel"]},contextShape:{apiVersion:"string",tool:"{ id: string, title: string, description: string }",environment:"{ apiVersion, toolId, toolTitle, toolDescription, generatedAt }",profile:"normalized customer profile with fields, vars, tokenValues, photos and attachments",variables:"TemplateVars object",values:"token values plus compatibility aliases",tokenValues:"original token-keyed values",tokens:"Array<{ token, label, key, inputType, value, internal, aliases }>",fields:"Array<{ label, value, source, token, key, section, aliases }>",fieldIndex:"normalized lookup object",client:"raw imported client payload or null",clientInfo:"visible client detail sections",clientSummary:"compact client bar fields",generatedAt:"ISO timestamp"},functions:{"TemplateTool.getContext()":"Promise<TemplateContext>","TemplateTool.getProfile()":"Promise<TemplateProfile>","TemplateTool.getVars()":"Promise<TemplateVars>","TemplateTool.getVar(name, fallback = '')":"Promise<string>","TemplateTool.hasVariable(name)":"Promise<boolean>","TemplateTool.listVariables()":"Promise<string[]>","TemplateTool.findField(candidates)":"Promise<Field|null>","TemplateTool.getFieldValue(candidates, fallback = '')":"Promise<string>","TemplateTool.copyText(text, message)":"Promise<{ ok: boolean }>","TemplateTool.copyHtml(html, message)":"Promise<{ ok: boolean }>","TemplateTool.toast(message, variant)":"Promise<{ ok: boolean }>","TemplateTool.openUrl(url)":"Promise<{ ok: boolean }>","TemplateTool.close()":"void","TemplateTool.requestResize()":"void","TemplateTool.onContext(callback)":"unsubscribe function","TemplateTool.describeApi()":"TemplateAPI reference"}});function It(e=Ie){const t=[`${e.name} (${e.version})`,"","Globals:"];return Object.entries(e.globals||{}).forEach(([n,r])=>{t.push(`- window.${n}: ${r.description}`)}),t.push("","Variable access:",`- ${e.variables.access}`),(e.variables.examples||[]).forEach(n=>{t.push(`- ${n}`)}),t.push(`- Reserved TemplateVars containers: ${(e.variables.reservedContainers||[]).join(", ")}`),t.push("","Context shape:"),Object.entries(e.contextShape||{}).forEach(([n,r])=>{t.push(`- ${n}: ${r}`)}),t.push("","Functions:"),Object.entries(e.functions||{}).forEach(([n,r])=>{t.push(`- ${n}: ${r}`)}),t.join(`
`)}const vt=`
...
</html>`:St}function At(e,t,n){return e.includes(n)?e:/<\/head\s*>/i.test(e)?e.replace(/<\/head\s*>/i,`${t}</head>`):/<head[\s>]/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>${t}`):/<html[\s>]/i.test(e)?e.replace(/<html([^>]*)>/i,`<html$1>${t}`):`${t}${e}`}function Et(e,t,n){return e.includes(n)?e:/<head[\s>]/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>${t}`):/<html[\s>]/i.test(e)?e.replace(/<html([^>]*)>/i,`<html$1>${t}`):`${t}${e}`}function $n(e=""){const t=Ct(e),n=Et(t,Nt,"template-tool-bridge");return At(n,vt,"template-tool-host-style")}function Lt(e=[],t={}){return Array.isArray(e)?e.filter(n=>n==null?void 0:n.token).map(n=>{const r=Object.prototype.hasOwnProperty.call(t,n.token)?t[n.token]:n.previewValue;return{token:n.token,label:n.label||n.token,key:n.key||"",inputType:n.input_type||n.inputType||"text",value:r??"",internal:!!n.internal,aliases:Array.isArray(n.searchAliases)?n.searchAliases.filter(Boolean):[]}}):[]}function E(e){return e==null?"":typeof e=="string"?e.trim():typeof e=="number"||typeof e=="boolean"?String(e):""}function P(e=""){return String(e||"").replace(/[{}]/g,"").replace(/([a-z0-9])([A-Z])/g,"$1 $2").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/&/g,"and").replace(/[^a-z0-9]+/g,"")}function ve(e=""){return String(e||"").replace(/[{}]/g,"").replace(/([a-z0-9])([A-Z])/g,"$1 $2").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/&/g,"and").replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}function Ne(e=""){const t=ve(e);return t?t.replace(/_([a-z0-9])/g,(n,r)=>r.toUpperCase()):""}function Se(e=""){const t=Ne(e);return t?/^[A-Za-z_$]/.test(t)?t:`field${t.charAt(0).toUpperCase()}${t.slice(1)}`:""}function ie(e=""){return String(e||"").split(".").map(t=>t.trim()).filter(Boolean)}function O(e,t){const n=String(t||"").trim();!n||e.includes(n)||e.push(n)}function v(e,t){const n=String(t||"").trim();if(!n)return;O(e,n);const r=ve(n),o=Ne(n);r&&(O(e,r),O(e,`{${r}}`)),o&&O(e,o)}function Dt({label:e="",token:t="",key:n="",aliases:r=[],section:o=""}={}){const a=[];v(a,e),v(a,t),v(a,t.replace(/[{}]/g,"")),v(a,n);const s=ie(n);return s.length>0&&(v(a,s[s.length-1]),v(a,s.join(" ")),v(a,s.join(""))),v(a,o),r.forEach(i=>v(a,i)),a}function Ot(e){const t=E(e.value);if(t==="")return null;const n={label:String(e.label||e.token||e.key||"Field"),value:t,source:e.source||"context"};return e.token&&(n.token=String(e.token)),e.key&&(n.key=String(e.key)),e.section&&(n.section=String(e.section)),n.aliases=Dt({...e,...n}),n}function Vt({tokens:e=[],clientInfo:t=[],clientSummary:n=[],profile:r=null}={}){const o=[],a=new Set,s=i=>{const u=Ot(i);if(!u)return;const f=`${u.source}:${u.label}:${u.value}:${u.token||""}:${u.key||""}`;a.has(f)||(a.add(f),o.push(u))};return e.forEach(i=>{s({label:i.label,value:i.value,token:i.token,key:i.key,aliases:i.aliases,source:"token"})}),n.forEach(i=>{s({label:i.label,value:i.value,section:"summary",source:"clientSummary"})}),t.forEach(i=>{((i==null?void 0:i.fields)||[]).forEach(u=>{s({label:u.label,value:u.value,section:i.title||i.id,source:"clientInfo"})})}),r&&typeof r=="object"&&(Array.isArray(r.availableFields)?r.availableFields:[]).forEach(i=>{s({label:i.label,value:i.value,key:i.key,aliases:i.aliases,source:"profile"})}),o}function jt(e,t,n){!t||n===""||Object.prototype.hasOwnProperty.call(e,t)||(e[t]=n)}function Ft(e,t,n){const r=ie(t);if(r.length<2||n==="")return;let o=e;for(let s=0;s<r.length-1;s+=1){const i=r[s];if(!i||/^\d+$/.test(i)||(o[i]===void 0&&(o[i]={}),!o[i]||typeof o[i]!="object"||Array.isArray(o[i])))return;o=o[i]}const a=r[r.length-1];a&&!Object.prototype.hasOwnProperty.call(o,a)&&(o[a]=n)}function $t(e={},t=[]){const n={...e};return t.forEach(r=>{r.key&&Ft(n,r.key,r.value),r.aliases.forEach(o=>jt(n,o,r.value))}),_e(n,t),n}const zt=Object.freeze([{name:"clientName",candidates:["clientName","client name","fullName","full name","name","client.name"]}]);function Bt(e,t){const n=P(t);return!e||!n?!1:[e.label,e.token,e.key,...e.aliases||[]].some(r=>P(r)===n)}function Rt(e=[],t=[]){for(const n of t){const r=e.find(a=>Bt(a,n)),o=E(r==null?void 0:r.value);if(o!=="")return o}return""}function _e(e,t=[]){zt.forEach(({name:n,candidates:r})=>{if(Object.prototype.hasOwnProperty.call(e,n))return;const o=Rt(t,r);o!==""&&(e[n]=o)})}function Mt(e=[]){const t={};return e.forEach(n=>{[n.label,n.token,n.key,...n.aliases||[]].forEach(r=>{const o=P(r);!o||t[o]||(t[o]={label:n.label,value:n.value,source:n.source,token:n.token||"",key:n.key||"",section:n.section||""})})}),t}function $(e,t,n){const r=Se(t);!r||n===""||Object.prototype.hasOwnProperty.call(e,r)||(e[r]=n)}function Kt(e,t,n){const r=ie(t).map(Se).filter(Boolean);if(r.length<2||n==="")return;let o=e;for(let s=0;s<r.length-1;s+=1){const i=r[s];if(o[i]===void 0&&(o[i]={}),!o[i]||typeof o[i]!="object"||Array.isArray(o[i]))return;o=o[i]}const a=r[r.length-1];a&&!Object.prototype.hasOwnProperty.call(o,a)&&(o[a]=n)}function Ut(e,t=null){if(!t||typeof t!="object")return;const n=t.vars&&typeof t.vars=="object"?t.vars:t.variables&&typeof t.variables=="object"?t.variables:{};Object.entries(n).forEach(([r,o])=>{const a=E(o);a!==""&&$(e,r,a)})}function qt({fields:e=[],tokenValues:t={},environment:n={},profile:r=null}={}){const o={env:n,raw:t,byToken:{},byKey:{},byLabel:{}};return Object.entries(t||{}).forEach(([a,s])=>{const i=E(s);i!==""&&(o.byToken[a]=i,$(o,a,i),$(o,a.replace(/[{}]/g,""),i))}),Ut(o,r),e.forEach(a=>{const s=E(a.value);s!==""&&(a.token&&(o.byToken[a.token]=s),a.key&&(o.byKey[a.key]=s,Kt(o,a.key,s)),o.byLabel[a.label]=s,[a.label,a.token,a.key,...a.aliases||[]].forEach(i=>{$(o,i,s)}))}),_e(o,e),o}function zn({tool:e={},values:t={},tokens:n=[],client:r=null,clientInfo:o=[],clientSummary:a=[],profile:s=null}={}){const i=t&&typeof t=="object"?t:{},u=s&&typeof s=="object"?s:null,f=u!=null&&u.tokenValues&&typeof u.tokenValues=="object"?u.tokenValues:{},l={...i,...f},c=Array.isArray(o)?o:[],d=Array.isArray(a)?a:[],p=Lt(n,l),b=Vt({tokens:p,clientInfo:c,clientSummary:d,profile:u}),y=new Date().toISOString(),I={apiVersion:R,toolId:e.id||"",toolTitle:e.title||"",toolDescription:e.description||"",generatedAt:y};return{apiVersion:R,tool:{id:e.id||"",title:e.title||"",description:e.description||""},profile:u||null,values:$t(l,b),tokenValues:l,tokens:p,fields:b,fieldIndex:Mt(b),variables:qt({fields:b,tokenValues:l,environment:I,profile:u}),environment:I,client:r&&typeof r=="object"?r:null,clientInfo:c,clientSummary:d,generatedAt:y}}function Bn({title:e="",prompt:t=""}={}){const n=String(e||"").trim()||"Custom tool",r=String(t||"").trim()||"Create a useful workflow tool for my Template Generator app.";return`You are building a custom Beta module for a local app called Template Generator.
