import{c as H}from"./createLucideIcon-DCpA5nME.js";import{p as G,b as oe,S as $,L as Z,H as Ee,o as ie,w as mt,F as _e,T as Le,W as se,X as le,Y as pt}from"./tokenService-CCvWWbg4.js";import{l as ft,s as bt}from"./index-C_Z7j2V-.js";import{l as F,s as ce,d as ht}from"./templateTreeService-8qv0fY5o.js";import{f as Oe,u as De}from"./templateTreeOperations-BNY2Zk7R.js";/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const gt=[["path",{d:"m15 18-6-6 6-6",key:"1wnfg3"}]],lr=H("chevron-left",gt);/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Tt=[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]],cr=H("chevron-right",Tt);/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const yt=[["rect",{width:"8",height:"4",x:"8",y:"2",rx:"1",ry:"1",key:"tgr4d6"}],["path",{d:"M8 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2",key:"4jdomd"}],["path",{d:"M16 4h2a2 2 0 0 1 2 2v4",key:"3hqy98"}],["path",{d:"M21 14H11",key:"1bme5i"}],["path",{d:"m15 10-4 4 4 4",key:"5dvupr"}]],ur=H("clipboard-copy",yt);/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const kt=[["path",{d:"M15.39 4.39a1 1 0 0 0 1.68-.474 2.5 2.5 0 1 1 3.014 3.015 1 1 0 0 0-.474 1.68l1.683 1.682a2.414 2.414 0 0 1 0 3.414L19.61 15.39a1 1 0 0 1-1.68-.474 2.5 2.5 0 1 0-3.014 3.015 1 1 0 0 1 .474 1.68l-1.683 1.682a2.414 2.414 0 0 1-3.414 0L8.61 19.61a1 1 0 0 0-1.68.474 2.5 2.5 0 1 1-3.014-3.015 1 1 0 0 0 .474-1.68l-1.683-1.682a2.414 2.414 0 0 1 0-3.414L4.39 8.61a1 1 0 0 1 1.68.474 2.5 2.5 0 1 0 3.014-3.015 1 1 0 0 1-.474-1.68l1.683-1.682a2.414 2.414 0 0 1 3.414 0z",key:"w46dr5"}]],dr=H("puzzle",kt),vt=/\.(jpe?g|png|webp|gif|bmp|avif)(?:$|[?#])/i,xt=/\.pdf(?:$|[?#])/i,wt=["{contractor}","{contractor_number}","{client_contractor_number}"];function g(...e){for(const t of e){const n=String(t??"").trim();if(n)return n}return""}function It(e){if(e&&typeof e=="object"&&!Array.isArray(e))return e;if(typeof e!="string")return null;try{const t=JSON.parse(e);return t&&typeof t=="object"&&!Array.isArray(t)?t:null}catch{return null}}function Nt(e="",t=""){const n=`${e} ${t}`;return vt.test(n)?"image":xt.test(n)?"pdf":"file"}function St(e=""){const t=String(e||"").trim().toLowerCase();return t==="image"||t.startsWith("image/")}function At(e={}){var t,n,r;return g(e.date,e.messageDate,e.messageDateTime,e.createdAt,e.created,e.sentAt,e.receivedAt,e.timestamp,(t=e.message)==null?void 0:t.date,(n=e.message)==null?void 0:n.createdAt,(r=e.message)==null?void 0:r.sentAt)||null}function D(e){if(e==null||e==="")return null;const t=Number(e);return Number.isInteger(t)&&t>=0?t:null}function Ct(e,t){var s,c,u,l,d;if(!e||typeof e!="object"||Array.isArray(e))return null;const n=g(e.url,e.href,e.src,e.downloadUrl);if(!n)return null;const r=g(e.name,e.filename,e.fileName,e.title,decodeURIComponent(((s=String(n).split("/").pop())==null?void 0:s.split("?")[0])||""))||`Attachment ${t+1}`,a=g(e.type,e.contentType,e.mimeType),i=St(a)?"image":Nt(r,n),o=g(e.messageId,e.messageID,e.postId,(c=e.message)==null?void 0:c.id)||null;return{id:g(e.id,e.attachmentId,e.documentId)||`${t}-${r}-${n}`,name:r,url:n,type:i,size:g(e.size,e.sizeText,e.fileSize)||null,messageId:o,postId:g(e.postId,o)||null,messageIndex:D(g(e.messageIndex,e.messageOrder,e.postIndex,(u=e.message)==null?void 0:u.index)),attachmentIndex:D(g(e.attachmentIndex,e.fileIndex)),messageAuthor:g(e.messageAuthor,e.author,e.createdBy,(l=e.message)==null?void 0:l.author,(d=e.message)==null?void 0:d.createdBy)||null,source:g(e.source,e.origin)||null,date:At(e)}}function xe(e){return String(e).padStart(2,"0")}function Et(e){const t=e.getFullYear(),n=xe(e.getMonth()+1),r=xe(e.getDate());return{dateKey:`${t}-${n}-${r}`,label:`${r}.${n}.${t}`,sortValue:new Date(t,e.getMonth(),e.getDate()).getTime()}}function we(e,t,n,r=0,a=0,i=0){if(t<0||t>11||n<1||n>31||r<0||r>23||a<0||a>59||i<0||i>59)return null;const o=new Date(e,t,n,r,a,i);return o.getFullYear()!==e||o.getMonth()!==t||o.getDate()!==n?null:o}function _t(e){if(e==null||e==="")return null;if(typeof e=="number"&&Number.isFinite(e)){const i=new Date(e);return Number.isNaN(i.getTime())?null:i}const t=String(e).trim();if(!t)return null;const n=t.match(/\b(\d{4})[./-](\d{1,2})[./-](\d{1,2})(?:[ T](\d{1,2}):(\d{2})(?::(\d{2}))?)?\b/);if(n){const i=we(Number(n[1]),Number(n[2])-1,Number(n[3]),Number(n[4]||0),Number(n[5]||0),Number(n[6]||0));if(i)return i}const r=t.match(/\b(\d{1,2})([./-])(\d{1,2})\2(\d{2,4})(?:[ T](\d{1,2}):(\d{2})(?::(\d{2}))?)?\b/);if(r){const i=Number(r[1]),o=r[2],s=Number(r[3]),c=Number(r[4]),u=c<100?2e3+c:c,l=Number(r[5]||0),d=Number(r[6]||0),m=Number(r[7]||0),f=o==="/"&&s>12&&i<=12,b=f?s:i,y=(f?i:s)-1,v=we(u,y,b,l,d,m);if(v)return v}const a=new Date(t);return Number.isNaN(a.getTime())?null:a}function ue(e={}){const t=_t(e.date);return t?Et(t):{dateKey:"unknown",label:"Date non disponible",sortValue:Number.NEGATIVE_INFINITY}}function Lt(e,t){const n=g(t);n&&wt.forEach(r=>{e[r]=n})}function Ie(e){return!!(e&&typeof e=="object"&&!Array.isArray(e))}function Ot(e,t,n){const r=Z(t),a=g(n);!r||!a||e.push([r,a])}function Ve(e,t=[]){const n=[];return Ie(e)&&Object.entries(e).forEach(([r,a])=>{if(Ie(a)){n.push(...Ve(a,[...t,r]));return}Ot(n,[...t,r].join("."),a)}),n}function Dt(e={}){const t={};return["tokenValues","values","variables","fields"].forEach(n=>{Ve(e[n]).forEach(([r,a])=>{t[r]=a})}),t}function X(e=[]){if(!Array.isArray(e))return[];const t=new Set;return e.map(Ct).filter(Boolean).filter(n=>{const r=`${n.name}|${n.url}`;return t.has(r)?!1:(t.add(r),!0)})}function z(e=[]){return X(e).filter(t=>t.type==="image")}function Vt(e=[]){const t=new Map;return z(e).forEach((n,r)=>{const a=ue(n);t.has(a.dateKey)||t.set(a.dateKey,{...a,attachments:[]}),t.get(a.dateKey).attachments.push({...n,galleryIndex:r})}),Array.from(t.values()).sort((n,r)=>r.sortValue-n.sortValue)}function Ne(e={}){var t;return g(e.postId,e.messageId,e.messageID,(t=e.message)==null?void 0:t.id)}function jt(e={},t=0){const n=D(e.messageNumber),r=D(e.messageIndex);return`Post ${n||(r===null?t+1:r+1)}`}function $t(e={}){const t=ue(e),n=g(e.messageAuthor);return t.dateKey==="unknown"?n:[t.label,n].filter(Boolean).join(" · ")}function mr(e=[]){const t=z(e);if(!t.some(r=>Ne(r)))return Vt(t);const n=new Map;return t.forEach((r,a)=>{const i=Ne(r),o=ue(r),s=i||`unassigned:${o.dateKey}`;if(!n.has(s)){const c=n.size;n.set(s,{dateKey:s,label:i?jt(r,c):o.label,metaLabel:i?$t(r):"",sortValue:D(r.messageIndex)??a,attachments:[]})}n.get(s).attachments.push({...r,galleryIndex:a})}),Array.from(n.values()).sort((r,a)=>r.sortValue-a.sortValue)}function pr(e){var f,b;const t=It(e);if(!t)return{ok:!1,error:"INVALID_SUPER_OFFICE_JSON"};const n=g(t.ticketId,t.soTicket,t.soTicketNumber,t.ticketNumber),r=g(t.createdAt,t.created,t.createdDate,t.ticketCreatedAt,t.ticketCreatedDate),a=g(t.externalTicketId,t.externalId,t.externalID,t.hcampExternalId),i=g(t.contractorNumber,t.contractor,t.contractorNo,t.customerId,t.customer,(f=t.client)==null?void 0:f.contractorNumber,(b=t.client)==null?void 0:b.contractor),o={};let s=null,c=!1;const u=X(t.attachments),l=z(u);if(a){const y=G(a);y.ok&&(c=!0,s=y.fields,Object.assign(o,oe(y.fields)))}Object.assign(o,Dt(t));const d=(s==null?void 0:s.customer)||i;d&&(c||n||u.length>0)&&Lt(o,d);const m=n||(s==null?void 0:s.soTicket)||"";return m&&(o[$]=m),Object.keys(o).length===0&&u.length===0?{ok:!1,error:"EMPTY_SUPER_OFFICE_DATA",externalIdValid:c,externalTicketId:a}:{ok:!0,ticketId:m,sourceTicketId:n,createdAt:r,externalTicketId:a,contractorNumber:d,externalIdValid:c,externalFields:s,tokenValues:o,attachments:u,imageAttachments:l,ignoredExternalId:!!(a&&!c)}}const de="super_office_ticket_payload",me="pending_super_office_ticket_payload",Ft="super-office-ticket-updated";function zt(e){if(!e||typeof e!="object"||Array.isArray(e))return e;const{[se]:t,[le]:n,...r}=e;return r}function ee(e){return Array.isArray(e)?`[${e.map(ee).join(",")}]`:e&&typeof e=="object"?`{${Object.keys(e).sort().map(t=>`${JSON.stringify(t)}:${ee(e[t])}`).join(",")}}`:JSON.stringify(e)}function pe(e=null){if(!e||typeof e!="object"||Array.isArray(e))return"";try{return ee(zt(e))}catch{return""}}function V(e){typeof window>"u"||window.dispatchEvent(new CustomEvent(Ft,{detail:{payload:e}}))}function W(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=X(e.attachments),n=String(e.clientSignature||"").trim(),r=e.tokenValues&&typeof e.tokenValues=="object"&&!Array.isArray(e.tokenValues)?Object.fromEntries(Object.entries(e.tokenValues).map(([a,i])=>[a,i==null?"":String(i)])):{};return{ticketId:String(e.ticketId||"").trim(),sourceTicketId:String(e.sourceTicketId||"").trim(),createdAt:String(e.createdAt||e.created||e.createdDate||"").trim(),externalTicketId:String(e.externalTicketId||"").trim(),importedAt:e.importedAt||new Date().toISOString(),clientSignature:n,tokenValues:r,attachments:t,imageAttachments:z(t)}}function Bt(e,t=new Date,n=""){return W({ticketId:(e==null?void 0:e.ticketId)||"",sourceTicketId:(e==null?void 0:e.sourceTicketId)||"",createdAt:(e==null?void 0:e.createdAt)||"",externalTicketId:(e==null?void 0:e.externalTicketId)||"",importedAt:t.toISOString(),clientSignature:n,tokenValues:(e==null?void 0:e.tokenValues)||{},attachments:(e==null?void 0:e.attachments)||[]})}async function fe(e){e&&await Le(de,e)}async function je(e){e&&await Le(me,e)}async function Q(){try{return W(await Ee(me,null))}catch(e){return console.error("loadPendingSuperOfficeTicketPayload error",e),null}}function fr(){return Q()}async function Mt(){return await $e()||await Q()}async function br(){return!!await Mt()}function be(){return _e(me)}async function hr(e){const t=await ie(),n=Bt(e,new Date,pe(t));return n?n.clientSignature?(await fe(n),await be(),V(n),n):(await q(),await je(n),V(null),n):null}async function gr(e){const t=mt(e);if(!t)return null;const n=await $e(),r=n?null:await Q(),a=n||r;if(!a)return null;const i=G(t),o=i.ok?{...a.tokenValues||{},...oe(i.fields)}:a.tokenValues||{},s=W({...a,externalTicketId:t,tokenValues:o});return s?(s.clientSignature?await fe(s):await je(s),V(s),s):null}function q(){return _e(de)}async function Tr(){const e=await Q(),t=pe(await ie());if(!e||!t)return null;const n={...e,clientSignature:t};return await fe(n),await be(),V(n),n}async function $e(){try{const e=await Ee(de,null);if(!e)return null;const t=pe(await ie());if(!t)return await q(),null;if((e==null?void 0:e.clientSignature)!==t)return await q(),null;const n=W(e);return n||null}catch(e){return console.error("loadSuperOfficeTicketPayload error",e),null}}async function yr(){await q(),await be(),V(null)}const Fe="quick_tools",Rt="blue",C=Object.freeze({LINK:"link",MODULE:"module"}),Kt=C.LINK,Ut=[{value:"blue",label:"Blue"},{value:"cyan",label:"Cyan"},{value:"emerald",label:"Green"},{value:"amber",label:"Amber"},{value:"rose",label:"Rose"},{value:"violet",label:"Violet"},{value:"slate",label:"Slate"}],Pt=new Set(Ut.map(e=>e.value)),qt=new Set(Object.values(C));function Jt(e){return Pt.has(e)?e:Rt}function ze(e){return qt.has(e)?e:Kt}function Yt(e){const t=Number(e);return Number.isFinite(t)?t:void 0}function Be(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=e.type||(e.html?C.MODULE:C.LINK),n=ze(t);return{...e,type:n,title:String(e.title||"").trim(),url:n===C.LINK?String(e.url||"").trim():"",description:String(e.description||"").trim(),prompt:String(e.prompt||""),html:String(e.html||""),color:Jt(e.color),order:Yt(e.order),beta:n===C.MODULE?!0:!!e.beta}}async function kr(){const e=await ft(Fe,[]);return Array.isArray(e)?e.map(Be).filter(Boolean):[]}async function vr(e){const t=Array.isArray(e)?e.map(Be).filter(Boolean):[];return bt(Fe,t)}function xr(e,t={}){return(e||"").replace(/\{[^}]+\}/g,n=>{const r=t[n];if(r==null||r==="")return n;const a=String(r).replace(/<[^>]+>/g,"").trim();return encodeURIComponent(a)})}function wr(e){return ze(e==null?void 0:e.type)===C.MODULE}const Ht=new Set(["title","description","channels","contentByChannel","favorite","nodeIds","parentNodeId","order"]);function he(e){return e==null?e:JSON.parse(JSON.stringify(e))}function O(e){return Array.isArray(e)?e:e==null||e===""?[]:[e]}function E(e=""){return String(e||"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}function Me(e=[]){return new Map(e.map(t=>[t.id,t]))}function Re(e,t){if(!e)return"";const n=[],r=new Set;let a=e;for(;a&&!r.has(a.id);)r.add(a.id),n.unshift(a.title||a.id),a=a.parentId?t.get(a.parentId):null;return n.join(" / ")}function Gt(e=[]){const t=Me(e);return e.map(n=>({...n,path:Re(n,t)}))}function Ke(e=[],t){const n=String(t||"").trim();if(!n)return null;const r=Me(e);if(r.has(n))return r.get(n);const a=E(n);return e.find(i=>E(i.title)===a||E(Re(i,r))===a)||null}function Zt(e=[],t={}){return Ke(e,t.fromNodeId||t.sourceNodeId||t.fromTopicId||t.sourceTopicId||t.fromNode||t.sourceNode||t.fromTopic||t.sourceTopic)}function Xt(e=[],t={}){return Ke(e,t.toNodeId||t.targetNodeId||t.toTopicId||t.targetTopicId||t.toNode||t.targetNode||t.toTopic||t.targetTopic)}function Wt(e,t={},n=null){const r=O(t.templateIds||t.templateId).map(String).filter(Boolean);if(r.length>0&&!r.includes(e.id)||n&&!(e.nodeIds||[]).includes(n.id))return!1;const a=O(t.channels||t.channel).map(s=>String(s||"").trim()).filter(Boolean);if(a.length>0&&!a.some(s=>(e.channels||[]).includes(s)))return!1;const i=String(t.title||t.templateTitle||"").trim();if(i&&E(e.title)!==E(i))return!1;const o=O(t.titleIncludes||t.templateTitleIncludes).map(E).filter(Boolean);if(o.length>0){const s=E(e.title);if(!o.some(c=>s.includes(c)))return!1}return!0}function Qt({template:e,sourceNode:t,targetNode:n,reason:r=""}){return{action:"moveTemplate",templateId:e.id,templateTitle:e.title||"",sourceNodeId:(t==null?void 0:t.id)||null,sourceNodeTitle:(t==null?void 0:t.title)||"",targetNodeId:n.id,targetNodeTitle:n.title||"",reason:r}}function Ue({nodes:e=[],templates:t=[]}={}){return{nodes:Gt(e),templates:he(t),counts:{nodes:e.length,templates:t.length}}}function Pe(e={}){if(!e||typeof e!="object"||Array.isArray(e))throw new Error("Template patch must be an object.");const t={};return Object.entries(e).forEach(([n,r])=>{Ht.has(n)&&(t[n]=r)}),t}async function qe(){return Ue(await F())}async function en(){return qe()}async function tn(e=[]){const t=O(e),{nodes:n,templates:r}=await F(),a=[],i=[];return t.forEach((o,s)=>{if(!o||typeof o!="object"||Array.isArray(o)){i.push({ruleIndex:s,reason:"Rule must be an object."});return}const c=Xt(n,o);if(!c){i.push({ruleIndex:s,reason:"Target topic was not found."});return}const u=Zt(n,o),l=r.filter(d=>Wt(d,o,u));if(l.length===0){i.push({ruleIndex:s,reason:"No templates matched this rule."});return}l.forEach(d=>{(d.nodeIds||[])[0]===c.id&&(!u||u.id===c.id)||a.push(Qt({template:d,sourceNode:u,targetNode:c,reason:o.reason||`Rule ${s+1}`}))})}),{ok:!0,ruleCount:t.length,operationCount:a.length,affectedTemplateCount:new Set(a.map(o=>o.templateId)).size,operations:a,skipped:i}}async function nn(e=[]){const t=O(e),n=await F();let r=n.nodes,a=n.templates;const i=[],o=[];return t.forEach((s,c)=>{var l;const u=(s==null?void 0:s.action)||(s==null?void 0:s.type);if(!s||typeof s!="object"||Array.isArray(s)){o.push({operationIndex:c,reason:"Operation must be an object."});return}if(u==="moveTemplate"){const d=String(s.templateId||""),m=String(s.targetNodeId||s.toNodeId||"");if(!d||!m){o.push({operationIndex:c,reason:"moveTemplate requires templateId and targetNodeId."});return}const f=a.find(v=>v.id===d),b=s.sourceNodeId||((l=f==null?void 0:f.nodeIds)==null?void 0:l[0])||null,y=JSON.stringify(a);a=Oe(a,d,b,m,Number(s.targetIndex),r),JSON.stringify(a)!==y&&i.push({operationIndex:c,action:u,templateId:d,targetNodeId:m});return}if(u==="updateTemplate"){const d=String(s.templateId||"");if(!d){o.push({operationIndex:c,reason:"updateTemplate requires templateId."});return}const m=Pe(s.patch||s.fields||{}),f=JSON.stringify(a);a=De(a,d,m),JSON.stringify(a)!==f&&i.push({operationIndex:c,action:u,templateId:d});return}o.push({operationIndex:c,reason:`Unsupported operation: ${u||"unknown"}.`})}),i.length>0&&await ce({nodes:r,templates:a}),{ok:!0,appliedCount:i.length,skippedCount:o.length,applied:i,skipped:o,tree:Ue({nodes:r,templates:a})}}async function rn(e,t={}){const n=String(e||"");if(!n)throw new Error("templateId is required.");const r=await F();if(!r.templates.some(i=>i.id===n))throw new Error("Template was not found.");const a=De(r.templates,n,Pe(t));return await ce({nodes:r.nodes,templates:a}),{ok:!0,template:he(a.find(i=>i.id===n))}}async function an(e,t,n={}){var u;const r=String(e||""),a=String(t||"");if(!r||!a)throw new Error("templateId and targetNodeId are required.");const i=await F();if(!i.templates.some(l=>l.id===r))throw new Error("Template was not found.");const o=i.templates.find(l=>l.id===r),s=(n==null?void 0:n.sourceNodeId)||((u=o==null?void 0:o.nodeIds)==null?void 0:u[0])||null,c=Oe(i.templates,r,s,a,Number(n==null?void 0:n.targetIndex),i.nodes);return await ce({nodes:i.nodes,templates:c}),{ok:!0,template:he(ht(c.find(l=>l.id===r)))}}async function Ir(e,t={}){switch(e){case"tool:templates:list":return qe();case"tool:templates:get-tree":return en();case"tool:templates:preview-migration":return tn(t.rules||t);case"tool:templates:apply-migration":return nn(t.operations||t);case"tool:templates:update-template":return rn(t.templateId,t.patch||t.fields||{});case"tool:templates:move-template":return an(t.templateId,t.targetNodeId,t.options||{});default:throw new Error("Unsupported template module request.")}}const J="template-tool-module-beta-1",Je=Object.freeze({name:"Template Generator Module API",version:J,globals:{TemplateTool:{type:"object",description:"Host bridge used by module JavaScript to read data, copy content, show feedback and control the module modal."},TemplateVars:{type:"object",description:"Runtime variables with safe JavaScript property names, populated after TemplateTool.getContext()."},TemplateProfile:{type:"object",description:"Normalized customer profile with easy fields, variables, tokens, photos and attachments."},TemplateEnv:{type:"object",description:"Execution metadata for the current module."},TemplateFields:{type:"array",description:"Normalized visible fields available to the module."},TemplateContext:{type:"object",description:"Full runtime context returned by TemplateTool.getContext()."},TemplateAPI:{type:"object",description:"Static API reference exposed inside every module."}},variables:{access:"await TemplateTool.getContext(); then read window.TemplateVars",examples:["TemplateVars.clientName","TemplateVars.mobile","TemplateVars.contractor","TemplateVars.activationDate","TemplateVars.otoId","TemplateVars.soTicketNum","TemplateVars.byToken['{client_first_name}']","TemplateVars.byKey['client.firstName']","TemplateVars.byLabel['Full name']","TemplateVars.available.map((entry) => entry.name)"],reservedContainers:["env","raw","byToken","byKey","byLabel","available","availableTokens","availableFields"]},contextShape:{apiVersion:"string",tool:"{ id: string, title: string, description: string }",environment:"{ apiVersion, toolId, toolTitle, toolDescription, generatedAt }",profile:"normalized customer profile with fields, vars, tokenValues, photos and attachments",variables:"TemplateVars object with scalar aliases plus available, availableTokens, availableFields, byToken, byKey and byLabel discovery containers",values:"token values plus compatibility aliases",tokenValues:"original token-keyed values",tokens:"Array<{ token, label, key, inputType, value, internal, aliases }>",fields:"Array<{ label, value, source, token, key, section, aliases }>",fieldIndex:"normalized lookup object",client:"raw imported client payload or null",clientInfo:"visible client detail sections",clientSummary:"compact client bar fields",generatedAt:"ISO timestamp"},functions:{"TemplateTool.getContext()":"Promise<TemplateContext>","TemplateTool.getProfile()":"Promise<TemplateProfile>","TemplateTool.getVars()":"Promise<TemplateVars>","TemplateTool.getVar(name, fallback = '')":"Promise<string>","TemplateTool.hasVariable(name)":"Promise<boolean>","TemplateTool.listVariables()":"Promise<string[]>","TemplateTool.findField(candidates)":"Promise<Field|null>","TemplateTool.getFieldValue(candidates, fallback = '')":"Promise<string>","TemplateTool.templates.list()":"Promise<{ nodes, templates, counts }>","TemplateTool.templates.getTree()":"Promise<{ nodes, templates, counts }>","TemplateTool.templates.previewMigration(rules)":"Promise<{ operations, skipped, operationCount, affectedTemplateCount }>","TemplateTool.templates.applyMigration(operations)":"Promise<{ ok, appliedCount, skippedCount, tree }>","TemplateTool.templates.updateTemplate(templateId, patch)":"Promise<{ ok, template }>","TemplateTool.templates.moveTemplate(templateId, targetNodeId, options = {})":"Promise<{ ok, template }>","TemplateTool.copyText(text, message)":"Promise<{ ok: boolean }>","TemplateTool.copyHtml(html, message)":"Promise<{ ok: boolean }>","TemplateTool.toast(message, variant)":"Promise<{ ok: boolean }>","TemplateTool.openUrl(url)":"Promise<{ ok: boolean }>","TemplateTool.close()":"void","TemplateTool.requestResize()":"void","TemplateTool.onContext(callback)":"unsubscribe function","TemplateTool.describeApi()":"TemplateAPI reference"}});function on(e=Je){const t=[`${e.name} (${e.version})`,"","Globals:"];return Object.entries(e.globals||{}).forEach(([n,r])=>{t.push(`- window.${n}: ${r.description}`)}),t.push("","Variable access:",`- ${e.variables.access}`),(e.variables.examples||[]).forEach(n=>{t.push(`- ${n}`)}),t.push(`- Reserved TemplateVars containers: ${(e.variables.reservedContainers||[]).join(", ")}`),t.push("","Context shape:"),Object.entries(e.contextShape||{}).forEach(([n,r])=>{t.push(`- ${n}: ${r}`)}),t.push("","Functions:"),Object.entries(e.functions||{}).forEach(([n,r])=>{t.push(`- ${n}: ${r}`)}),t.join(`
`)}const sn=`
