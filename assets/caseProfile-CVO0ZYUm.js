import{c as Ee}from"./appConfigService-Die170qS.js";import{p as J,b as ne,S as H,P as Y,K as _e,q as ae,x as st,G as Oe,U as Le,X as re,Y as oe,Z as lt}from"./tokenService--bgIcq3B.js";import{l as j,s as ie,d as ct}from"./templateTreeService-B_xAmcJS.js";import{f as De,u as Ve}from"./templateTreeOperations-SgzQP8J8.js";/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ut=[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]],Qn=Ee("chevron-right",ut);/**
 * @license lucide-react v1.17.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const dt=[["path",{d:"M15.39 4.39a1 1 0 0 0 1.68-.474 2.5 2.5 0 1 1 3.014 3.015 1 1 0 0 0-.474 1.68l1.683 1.682a2.414 2.414 0 0 1 0 3.414L19.61 15.39a1 1 0 0 1-1.68-.474 2.5 2.5 0 1 0-3.014 3.015 1 1 0 0 1 .474 1.68l-1.683 1.682a2.414 2.414 0 0 1-3.414 0L8.61 19.61a1 1 0 0 0-1.68.474 2.5 2.5 0 1 1-3.014-3.015 1 1 0 0 0 .474-1.68l-1.683-1.682a2.414 2.414 0 0 1 0-3.414L4.39 8.61a1 1 0 0 1 1.68.474 2.5 2.5 0 1 0 3.014-3.015 1 1 0 0 1-.474-1.68l1.683-1.682a2.414 2.414 0 0 1 3.414 0z",key:"w46dr5"}]],ea=Ee("puzzle",dt),mt=/\.(jpe?g|jfif|png|webp|gif|bmp|avif|heic|heif|tiff?|ico|svg)(?:$|[?#])/i,pt=/\.(mp4|mov)(?:$|[?#])/i,ft=/\.pdf(?:$|[?#])/i,bt=["{contractor}","{contractor_number}","{client_contractor_number}"];function g(...e){for(const t of e){const n=String(t??"").trim();if(n)return n}return""}function ht(e){if(e&&typeof e=="object"&&!Array.isArray(e))return e;if(typeof e!="string")return null;try{const t=JSON.parse(e);return t&&typeof t=="object"&&!Array.isArray(t)?t:null}catch{return null}}function gt(e="",t=""){const n=`${e} ${t}`;return mt.test(n)?"image":pt.test(n)?"video":ft.test(n)?"pdf":"file"}function Tt(e=""){const t=String(e||"").trim().toLowerCase();return t==="image"||t.startsWith("image/")}function yt(e=""){const t=String(e||"").trim().toLowerCase();return t==="video"||t==="mp4"||t==="mov"||t.startsWith("video/")}function kt(e=""){const t=String(e||"").trim().toLowerCase();return t==="pdf"||t==="application/pdf"}function vt(...e){for(const t of e){if(Tt(t))return"image";if(yt(t))return"video";if(kt(t))return"pdf"}return""}function xt(...e){for(const t of e){const n=g(t),a=n.toLowerCase();if(a){if(a.includes("/"))return n;if(a==="pdf")return"application/pdf";if(a==="mp4")return"video/mp4";if(a==="mov")return"video/quicktime"}}return""}function wt(e={}){var t,n,a;return g(e.date,e.messageDate,e.messageDateTime,e.createdAt,e.created,e.sentAt,e.receivedAt,e.timestamp,(t=e.message)==null?void 0:t.date,(n=e.message)==null?void 0:n.createdAt,(a=e.message)==null?void 0:a.sentAt)||null}function L(e){if(e==null||e==="")return null;const t=Number(e);return Number.isInteger(t)&&t>=0?t:null}function It(e,t){var c,u,l,d,m;if(!e||typeof e!="object"||Array.isArray(e))return null;const n=g(e.url,e.href,e.src,e.downloadUrl);if(!n)return null;const a=g(e.name,e.filename,e.fileName,e.title,decodeURIComponent(((c=String(n).split("/").pop())==null?void 0:c.split("?")[0])||""))||`Attachment ${t+1}`,r=g(e.type,e.contentType,e.mimeType),o=xt(e.contentType,e.mimeType,e.type,e.mediaType),i=vt(e.type,e.contentType,e.mimeType,e.mediaType)||gt(a,n),s=g(e.messageId,e.messageID,e.postId,(u=e.message)==null?void 0:u.id)||null;return{id:g(e.id,e.attachmentId,e.documentId)||`${t}-${a}-${n}`,name:a,url:n,dataUrl:g(e.dataUrl)||null,type:i,contentType:o||r||null,size:g(e.size,e.sizeText,e.fileSize)||null,messageId:s,postId:g(e.postId,s)||null,messageIndex:L(g(e.messageIndex,e.messageOrder,e.postIndex,(l=e.message)==null?void 0:l.index)),attachmentIndex:L(g(e.attachmentIndex,e.fileIndex)),messageAuthor:g(e.messageAuthor,e.author,e.createdBy,(d=e.message)==null?void 0:d.author,(m=e.message)==null?void 0:m.createdBy)||null,source:g(e.source,e.origin)||null,date:wt(e)}}function ve(e){return String(e).padStart(2,"0")}function Nt(e){const t=e.getFullYear(),n=ve(e.getMonth()+1),a=ve(e.getDate());return{dateKey:`${t}-${n}-${a}`,label:`${a}.${n}.${t}`,sortValue:new Date(t,e.getMonth(),e.getDate()).getTime()}}function xe(e,t,n,a=0,r=0,o=0){if(t<0||t>11||n<1||n>31||a<0||a>23||r<0||r>59||o<0||o>59)return null;const i=new Date(e,t,n,a,r,o);return i.getFullYear()!==e||i.getMonth()!==t||i.getDate()!==n?null:i}function St(e){if(e==null||e==="")return null;if(typeof e=="number"&&Number.isFinite(e)){const o=new Date(e);return Number.isNaN(o.getTime())?null:o}const t=String(e).trim();if(!t)return null;const n=t.match(/\b(\d{4})[./-](\d{1,2})[./-](\d{1,2})(?:[ T](\d{1,2}):(\d{2})(?::(\d{2}))?)?\b/);if(n){const o=xe(Number(n[1]),Number(n[2])-1,Number(n[3]),Number(n[4]||0),Number(n[5]||0),Number(n[6]||0));if(o)return o}const a=t.match(/\b(\d{1,2})([./-])(\d{1,2})\2(\d{2,4})(?:[ T](\d{1,2}):(\d{2})(?::(\d{2}))?)?\b/);if(a){const o=Number(a[1]),i=a[2],s=Number(a[3]),c=Number(a[4]),u=c<100?2e3+c:c,l=Number(a[5]||0),d=Number(a[6]||0),m=Number(a[7]||0),b=i==="/"&&s>12&&o<=12,h=b?s:o,f=(b?o:s)-1,T=xe(u,f,h,l,d,m);if(T)return T}const r=new Date(t);return Number.isNaN(r.getTime())?null:r}function se(e={}){const t=St(e.date);return t?Nt(t):{dateKey:"unknown",label:"Date non disponible",sortValue:Number.NEGATIVE_INFINITY}}function At(e,t){const n=g(t);n&&bt.forEach(a=>{e[a]=n})}function we(e){return!!(e&&typeof e=="object"&&!Array.isArray(e))}function Ct(e,t,n){const a=Y(t),r=g(n);!a||!r||e.push([a,r])}function je(e,t=[]){const n=[];return we(e)&&Object.entries(e).forEach(([a,r])=>{if(we(r)){n.push(...je(r,[...t,a]));return}Ct(n,[...t,a].join("."),r)}),n}function Et(e={}){const t={};return["tokenValues","values","variables","fields"].forEach(n=>{je(e[n]).forEach(([a,r])=>{t[a]=r})}),t}function $(e=[]){if(!Array.isArray(e))return[];const t=new Set;return e.map(It).filter(Boolean).filter(n=>{const a=`${n.name}|${n.url}`;return t.has(a)?!1:(t.add(a),!0)})}function le(e=[]){return $(e).filter(t=>t.type==="image")}function ce(e=[]){return $(e).filter(t=>["image","video","pdf"].includes(t.type))}function _t(e=[]){const t=new Map;return e.forEach((n,a)=>{const r=se(n);t.has(r.dateKey)||t.set(r.dateKey,{...r,attachments:[]}),t.get(r.dateKey).attachments.push({...n,galleryIndex:a})}),Array.from(t.values()).sort((n,a)=>a.sortValue-n.sortValue)}function Ie(e={}){var t;return g(e.postId,e.messageId,e.messageID,(t=e.message)==null?void 0:t.id)}function Ot(e={},t=0){const n=L(e.messageNumber),a=L(e.messageIndex);return`Post ${n||(a===null?t+1:a+1)}`}function Lt(e={}){const t=se(e),n=g(e.messageAuthor);return t.dateKey==="unknown"?n:[t.label,n].filter(Boolean).join(" · ")}function ta(e=[]){const t=ce(e);if(!t.some(a=>Ie(a)))return _t(t);const n=new Map;return t.forEach((a,r)=>{const o=Ie(a),i=se(a),s=o||`unassigned:${i.dateKey}`;if(!n.has(s)){const c=n.size;n.set(s,{dateKey:s,label:o?Ot(a,c):i.label,metaLabel:o?Lt(a):"",sortValue:L(a.messageIndex)??r,attachments:[]})}n.get(s).attachments.push({...a,galleryIndex:r})}),Array.from(n.values()).sort((a,r)=>a.sortValue-r.sortValue)}function na(e){var h,f;const t=ht(e);if(!t)return{ok:!1,error:"INVALID_SUPER_OFFICE_JSON"};const n=g(t.ticketId,t.soTicket,t.soTicketNumber,t.ticketNumber),a=g(t.createdAt,t.created,t.createdDate,t.ticketCreatedAt,t.ticketCreatedDate),r=g(t.externalTicketId,t.externalId,t.externalID,t.hcampExternalId),o=g(t.contractorNumber,t.contractor,t.contractorNo,t.customerId,t.customer,(h=t.client)==null?void 0:h.contractorNumber,(f=t.client)==null?void 0:f.contractor),i={};let s=null,c=!1;const u=$(t.attachments),l=le(u),d=ce(u);if(r){const T=J(r);T.ok&&(c=!0,s=T.fields,Object.assign(i,ne(T.fields)))}Object.assign(i,Et(t));const m=(s==null?void 0:s.customer)||o;m&&(c||n||u.length>0)&&At(i,m);const b=n||(s==null?void 0:s.soTicket)||"";return b&&(i[H]=b),Object.keys(i).length===0&&u.length===0?{ok:!1,error:"EMPTY_SUPER_OFFICE_DATA",externalIdValid:c,externalTicketId:r}:{ok:!0,ticketId:b,sourceTicketId:n,createdAt:a,externalTicketId:r,contractorNumber:m,externalIdValid:c,externalFields:s,tokenValues:i,attachments:u,imageAttachments:l,mediaAttachments:d,ignoredExternalId:!!(r&&!c)}}const ue="super_office_ticket_payload",de="pending_super_office_ticket_payload",Dt="super-office-ticket-updated";function Vt(e){if(!e||typeof e!="object"||Array.isArray(e))return e;const{[re]:t,[oe]:n,...a}=e;return a}function W(e){return Array.isArray(e)?`[${e.map(W).join(",")}]`:e&&typeof e=="object"?`{${Object.keys(e).sort().map(t=>`${JSON.stringify(t)}:${W(e[t])}`).join(",")}}`:JSON.stringify(e)}function me(e=null){if(!e||typeof e!="object"||Array.isArray(e))return"";try{return W(Vt(e))}catch{return""}}function D(e){typeof window>"u"||window.dispatchEvent(new CustomEvent(Dt,{detail:{payload:e}}))}function G(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=$(e.attachments),n=String(e.clientSignature||"").trim(),a=e.tokenValues&&typeof e.tokenValues=="object"&&!Array.isArray(e.tokenValues)?Object.fromEntries(Object.entries(e.tokenValues).map(([r,o])=>[r,o==null?"":String(o)])):{};return{ticketId:String(e.ticketId||"").trim(),sourceTicketId:String(e.sourceTicketId||"").trim(),createdAt:String(e.createdAt||e.created||e.createdDate||"").trim(),externalTicketId:String(e.externalTicketId||"").trim(),importedAt:e.importedAt||new Date().toISOString(),clientSignature:n,tokenValues:a,attachments:t,imageAttachments:le(t),mediaAttachments:ce(t)}}function jt(e,t=new Date,n=""){return G({ticketId:(e==null?void 0:e.ticketId)||"",sourceTicketId:(e==null?void 0:e.sourceTicketId)||"",createdAt:(e==null?void 0:e.createdAt)||"",externalTicketId:(e==null?void 0:e.externalTicketId)||"",importedAt:t.toISOString(),clientSignature:n,tokenValues:(e==null?void 0:e.tokenValues)||{},attachments:(e==null?void 0:e.attachments)||[]})}async function pe(e){e&&await Le(ue,e)}async function $e(e){e&&await Le(de,e)}async function Z(){try{return G(await _e(de,null))}catch(e){return console.error("loadPendingSuperOfficeTicketPayload error",e),null}}function aa(){return Z()}async function $t(){return await Fe()||await Z()}async function ra(){return!!await $t()}function fe(){return Oe(de)}async function oa(e){const t=await ae(),n=jt(e,new Date,me(t));return n?n.clientSignature?(await pe(n),await fe(),D(n),n):(await U(),await $e(n),D(null),n):null}async function ia(e){const t=st(e);if(!t)return null;const n=await Fe(),a=n?null:await Z(),r=n||a;if(!r)return null;const o=J(t),i=o.ok?{...r.tokenValues||{},...ne(o.fields)}:r.tokenValues||{},s=G({...r,externalTicketId:t,tokenValues:i});return s?(s.clientSignature?await pe(s):await $e(s),D(s),s):null}function U(){return Oe(ue)}async function sa(){const e=await Z(),t=me(await ae());if(!e||!t)return null;const n={...e,clientSignature:t};return await pe(n),await fe(),D(n),n}async function Fe(){try{const e=await _e(ue,null);if(!e)return null;const t=me(await ae());if(!t)return await U(),null;if((e==null?void 0:e.clientSignature)!==t)return await U(),null;const n=G(e);return n||null}catch(e){return console.error("loadSuperOfficeTicketPayload error",e),null}}async function la(){await U(),await fe(),D(null)}const Ft=new Set(["title","description","channels","contentByChannel","favorite","nodeIds","parentNodeId","order"]);function be(e){return e==null?e:JSON.parse(JSON.stringify(e))}function O(e){return Array.isArray(e)?e:e==null||e===""?[]:[e]}function A(e=""){return String(e||"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}function ze(e=[]){return new Map(e.map(t=>[t.id,t]))}function Me(e,t){if(!e)return"";const n=[],a=new Set;let r=e;for(;r&&!a.has(r.id);)a.add(r.id),n.unshift(r.title||r.id),r=r.parentId?t.get(r.parentId):null;return n.join(" / ")}function zt(e=[]){const t=ze(e);return e.map(n=>({...n,path:Me(n,t)}))}function Be(e=[],t){const n=String(t||"").trim();if(!n)return null;const a=ze(e);if(a.has(n))return a.get(n);const r=A(n);return e.find(o=>A(o.title)===r||A(Me(o,a))===r)||null}function Mt(e=[],t={}){return Be(e,t.fromNodeId||t.sourceNodeId||t.fromTopicId||t.sourceTopicId||t.fromNode||t.sourceNode||t.fromTopic||t.sourceTopic)}function Bt(e=[],t={}){return Be(e,t.toNodeId||t.targetNodeId||t.toTopicId||t.targetTopicId||t.toNode||t.targetNode||t.toTopic||t.targetTopic)}function Rt(e,t={},n=null){const a=O(t.templateIds||t.templateId).map(String).filter(Boolean);if(a.length>0&&!a.includes(e.id)||n&&!(e.nodeIds||[]).includes(n.id))return!1;const r=O(t.channels||t.channel).map(s=>String(s||"").trim()).filter(Boolean);if(r.length>0&&!r.some(s=>(e.channels||[]).includes(s)))return!1;const o=String(t.title||t.templateTitle||"").trim();if(o&&A(e.title)!==A(o))return!1;const i=O(t.titleIncludes||t.templateTitleIncludes).map(A).filter(Boolean);if(i.length>0){const s=A(e.title);if(!i.some(c=>s.includes(c)))return!1}return!0}function Pt({template:e,sourceNode:t,targetNode:n,reason:a=""}){return{action:"moveTemplate",templateId:e.id,templateTitle:e.title||"",sourceNodeId:(t==null?void 0:t.id)||null,sourceNodeTitle:(t==null?void 0:t.title)||"",targetNodeId:n.id,targetNodeTitle:n.title||"",reason:a}}function Re({nodes:e=[],templates:t=[]}={}){return{nodes:zt(e),templates:be(t),counts:{nodes:e.length,templates:t.length}}}function Pe(e={}){if(!e||typeof e!="object"||Array.isArray(e))throw new Error("Template patch must be an object.");const t={};return Object.entries(e).forEach(([n,a])=>{Ft.has(n)&&(t[n]=a)}),t}async function Ue(){return Re(await j())}async function Ut(){return Ue()}async function Kt(e=[]){const t=O(e),{nodes:n,templates:a}=await j(),r=[],o=[];return t.forEach((i,s)=>{if(!i||typeof i!="object"||Array.isArray(i)){o.push({ruleIndex:s,reason:"Rule must be an object."});return}const c=Bt(n,i);if(!c){o.push({ruleIndex:s,reason:"Target topic was not found."});return}const u=Mt(n,i),l=a.filter(d=>Rt(d,i,u));if(l.length===0){o.push({ruleIndex:s,reason:"No templates matched this rule."});return}l.forEach(d=>{(d.nodeIds||[])[0]===c.id&&(!u||u.id===c.id)||r.push(Pt({template:d,sourceNode:u,targetNode:c,reason:i.reason||`Rule ${s+1}`}))})}),{ok:!0,ruleCount:t.length,operationCount:r.length,affectedTemplateCount:new Set(r.map(i=>i.templateId)).size,operations:r,skipped:o}}async function qt(e=[]){const t=O(e),n=await j();let a=n.nodes,r=n.templates;const o=[],i=[];return t.forEach((s,c)=>{var l;const u=(s==null?void 0:s.action)||(s==null?void 0:s.type);if(!s||typeof s!="object"||Array.isArray(s)){i.push({operationIndex:c,reason:"Operation must be an object."});return}if(u==="moveTemplate"){const d=String(s.templateId||""),m=String(s.targetNodeId||s.toNodeId||"");if(!d||!m){i.push({operationIndex:c,reason:"moveTemplate requires templateId and targetNodeId."});return}const b=r.find(T=>T.id===d),h=s.sourceNodeId||((l=b==null?void 0:b.nodeIds)==null?void 0:l[0])||null,f=JSON.stringify(r);r=De(r,d,h,m,Number(s.targetIndex),a),JSON.stringify(r)!==f&&o.push({operationIndex:c,action:u,templateId:d,targetNodeId:m});return}if(u==="updateTemplate"){const d=String(s.templateId||"");if(!d){i.push({operationIndex:c,reason:"updateTemplate requires templateId."});return}const m=Pe(s.patch||s.fields||{}),b=JSON.stringify(r);r=Ve(r,d,m),JSON.stringify(r)!==b&&o.push({operationIndex:c,action:u,templateId:d});return}i.push({operationIndex:c,reason:`Unsupported operation: ${u||"unknown"}.`})}),o.length>0&&await ie({nodes:a,templates:r}),{ok:!0,appliedCount:o.length,skippedCount:i.length,applied:o,skipped:i,tree:Re({nodes:a,templates:r})}}async function Jt(e,t={}){const n=String(e||"");if(!n)throw new Error("templateId is required.");const a=await j();if(!a.templates.some(o=>o.id===n))throw new Error("Template was not found.");const r=Ve(a.templates,n,Pe(t));return await ie({nodes:a.nodes,templates:r}),{ok:!0,template:be(r.find(o=>o.id===n))}}async function Ht(e,t,n={}){var u;const a=String(e||""),r=String(t||"");if(!a||!r)throw new Error("templateId and targetNodeId are required.");const o=await j();if(!o.templates.some(l=>l.id===a))throw new Error("Template was not found.");const i=o.templates.find(l=>l.id===a),s=(n==null?void 0:n.sourceNodeId)||((u=i==null?void 0:i.nodeIds)==null?void 0:u[0])||null,c=De(o.templates,a,s,r,Number(n==null?void 0:n.targetIndex),o.nodes);return await ie({nodes:o.nodes,templates:c}),{ok:!0,template:be(ct(c.find(l=>l.id===a)))}}async function ca(e,t={}){switch(e){case"tool:templates:list":return Ue();case"tool:templates:get-tree":return Ut();case"tool:templates:preview-migration":return Kt(t.rules||t);case"tool:templates:apply-migration":return qt(t.operations||t);case"tool:templates:update-template":return Jt(t.templateId,t.patch||t.fields||{});case"tool:templates:move-template":return Ht(t.templateId,t.targetNodeId,t.options||{});default:throw new Error("Unsupported template module request.")}}const K="template-tool-module-beta-2",Ke=Object.freeze({name:"Template Generator Module API",version:K,globals:{TemplateTool:{type:"object",description:"Host bridge used by module JavaScript to read data, copy content, show feedback and control the module modal."},TemplateVars:{type:"object",description:"Runtime variables with safe JavaScript property names, populated after TemplateTool.getContext()."},TemplateProfile:{type:"object",description:"Normalized customer profile with easy fields, variables, tokens, photos and attachments."},TemplateEnv:{type:"object",description:"Execution metadata for the current module."},TemplateFields:{type:"array",description:"Normalized visible fields available to the module."},TemplateContext:{type:"object",description:"Full runtime context returned by TemplateTool.getContext()."},TemplateAPI:{type:"object",description:"Static API reference exposed inside every module."}},variables:{access:"await TemplateTool.getContext(); then read window.TemplateVars",containers:{"context.profile / TemplateProfile":"Normalized customer and case profile with common scalar fields, tokenValues, vars, photos and attachments.","context.variables / TemplateVars":"Variable-friendly aliases generated from profile fields, tokens and visible client fields. This is the preferred object for JavaScript property access.","TemplateVars.byToken":"Exact token lookup keyed by brace tokens such as {client_first_name}. Includes known tokens even when the current value is empty.","TemplateVars.byKey":"Lookup keyed by structured token keys such as client.firstName or contractorNumber.","TemplateVars.byLabel":"Lookup keyed by user-facing field labels from the app.","TemplateVars.available":"Discovery list for every exposed variable with names, token, key, label, value, source, inputType and internal.","TemplateVars.availableTokens":"Subset of TemplateVars.available that comes from token definitions.","TemplateVars.availableFields":"Visible normalized field list with aliases for customer-facing selectors.","context.tokens":"All configured token definitions, including manual/internal tokens and empty values.","context.fields / TemplateFields":"Best normalized list for user-facing customer, case and profile fields.","context.fieldIndex":"Normalized lookup map for labels, tokens, keys and aliases with punctuation/accent/braces removed.","context.client":"Raw imported VTI/customer payload. Use only when the module needs structured nested source data.","context.clientInfo":"Visible client detail sections used by the app UI.","context.clientSummary":"Compact client bar fields currently selected in the app."},examples:["TemplateVars.clientName","TemplateVars.mobile","TemplateVars.contractor","TemplateVars.activationDate","TemplateVars.otoId","TemplateVars.soTicketNum","TemplateVars.byToken['{client_first_name}']","TemplateVars.byKey['client.firstName']","TemplateVars.byLabel['Full name']","TemplateVars.available.map((entry) => entry.name)"],reservedContainers:["env","raw","byToken","byKey","byLabel","available","availableTokens","availableFields"]},dataAccess:{appDatabase:"Authorized only through TemplateTool APIs. TemplateTool.templates reads and writes the app's IndexedDB-backed topic/template data through host services.",internet:"Public Internet API/database access is authorized for explicit user-requested public HTTP(S) read requests. Prefer TemplateTool.fetchJson(url) or TemplateTool.fetchText(url) for CORS-enabled Internet APIs/databases.",restrictions:"Do not use secrets, cookies, credentials, private/local network URLs, remote scripts, CDNs, remote fonts, eval, parent DOM access, localStorage or raw IndexedDB."},contextShape:{apiVersion:"string",tool:"{ id: string, title: string, description: string }",environment:"{ apiVersion, toolId, toolTitle, toolDescription, generatedAt }",profile:"normalized customer profile with fields, vars, tokenValues, photos and attachments",variables:"TemplateVars object with scalar aliases plus available, availableTokens, availableFields, byToken, byKey and byLabel discovery containers",values:"token values plus compatibility aliases",tokenValues:"original token-keyed values",tokens:"Array<{ token, label, key, inputType, value, internal, aliases }>",fields:"Array<{ label, value, source, token, key, section, aliases }>",fieldIndex:"normalized lookup object",client:"raw imported client payload or null",clientInfo:"visible client detail sections",clientSummary:"compact client bar fields",generatedAt:"ISO timestamp"},functions:{"TemplateTool.getContext()":"Promise<TemplateContext>","TemplateTool.getProfile()":"Promise<TemplateProfile>","TemplateTool.getVars()":"Promise<TemplateVars>","TemplateTool.getVar(name, fallback = '')":"Promise<string>","TemplateTool.hasVariable(name)":"Promise<boolean>","TemplateTool.listVariables()":"Promise<string[]>","TemplateTool.findField(candidates)":"Promise<Field|null>","TemplateTool.getFieldValue(candidates, fallback = '')":"Promise<string>","TemplateTool.templates.list()":"Promise<{ nodes, templates, counts }>","TemplateTool.templates.getTree()":"Promise<{ nodes, templates, counts }>","TemplateTool.templates.previewMigration(rules)":"Promise<{ operations, skipped, operationCount, affectedTemplateCount }>","TemplateTool.templates.applyMigration(operations)":"Promise<{ ok, appliedCount, skippedCount, tree }>","TemplateTool.templates.updateTemplate(templateId, patch)":"Promise<{ ok, template }>","TemplateTool.templates.moveTemplate(templateId, targetNodeId, options = {})":"Promise<{ ok, template }>","TemplateTool.fetchJson(url)":"Promise<{ ok, status, url, contentType, data?, text?, error?, truncated? }>","TemplateTool.fetchText(url)":"Promise<{ ok, status, url, contentType, text?, error?, truncated? }>","TemplateTool.copyText(text, message)":"Promise<{ ok: boolean }>","TemplateTool.copyHtml(html, message)":"Promise<{ ok: boolean }>","TemplateTool.toast(message, variant)":"Promise<{ ok: boolean }>","TemplateTool.openUrl(url)":"Promise<{ ok: boolean }>","TemplateTool.close()":"void","TemplateTool.requestResize()":"void","TemplateTool.onContext(callback)":"unsubscribe function","TemplateTool.describeApi()":"TemplateAPI reference"}});function Yt(e=Ke){const t=[`${e.name} (${e.version})`,"","Globals:"];return Object.entries(e.globals||{}).forEach(([n,a])=>{t.push(`- window.${n}: ${a.description}`)}),t.push("","Variable access:",`- ${e.variables.access}`),e.variables.containers&&typeof e.variables.containers=="object"&&(t.push("","Variable containers:"),Object.entries(e.variables.containers).forEach(([n,a])=>{t.push(`- ${n}: ${a}`)})),t.push("","Variable examples:"),(e.variables.examples||[]).forEach(n=>{t.push(`- ${n}`)}),t.push(`- Reserved TemplateVars containers: ${(e.variables.reservedContainers||[]).join(", ")}`),e.dataAccess&&typeof e.dataAccess=="object"&&(t.push("","Data access:"),Object.entries(e.dataAccess).forEach(([n,a])=>{t.push(`- ${n}: ${a}`)})),t.push("","Context shape:"),Object.entries(e.contextShape||{}).forEach(([n,a])=>{t.push(`- ${n}: ${a}`)}),t.push("","Functions:"),Object.entries(e.functions||{}).forEach(([n,a])=>{t.push(`- ${n}: ${a}`)}),t.join(`
`)}const Gt=`
...
</html>`:Wt}function en(e,t,n){return e.includes(n)?e:/<\/head\s*>/i.test(e)?e.replace(/<\/head\s*>/i,`${t}</head>`):/<head[\s>]/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>${t}`):/<html[\s>]/i.test(e)?e.replace(/<html([^>]*)>/i,`<html$1>${t}`):`${t}${e}`}function tn(e,t,n){return e.includes(n)?e:/<head[\s>]/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>${t}`):/<html[\s>]/i.test(e)?e.replace(/<html([^>]*)>/i,`<html$1>${t}`):`${t}${e}`}function ua(e=""){const t=Qt(e),n=tn(t,Zt,"template-tool-bridge");return en(n,Gt,"template-tool-host-style")}const Ne=3e5;function nn(e=""){const t=e.split(".").map(r=>Number(r));if(t.length!==4||t.some(r=>!Number.isInteger(r)||r<0||r>255))return!1;const[n,a]=t;return n===0||n===10||n===127||n===169&&a===254||n===172&&a>=16&&a<=31||n===192&&a===168}function an(e=""){try{const t=new URL(String(e||"").trim());if(!["http:","https:"].includes(t.protocol))return!1;const n=t.hostname.toLowerCase().replace(/^\[|\]$/g,"");return!(!n||n==="localhost"||n.endsWith(".localhost")||n.endsWith(".local")||n==="::1"||n==="0:0:0:0:0:0:0:1"||nn(n))}catch{return!1}}async function da({url:e="",responseType:t="json"}={}){const n=String(e||"").trim(),a=t==="json";if(!an(n))return{ok:!1,status:0,url:n,contentType:"",error:"Only public http/https URLs can be fetched by a module."};try{const r=await fetch(n,{method:"GET",credentials:"omit",cache:"no-store",redirect:"follow",headers:{Accept:a?"application/json, text/plain;q=0.8, */*;q=0.5":"text/plain, application/json;q=0.8, */*;q=0.5"}}),o=r.headers.get("content-type")||"",i=await r.text(),s=i.length>Ne,c=s?i.slice(0,Ne):i,u={ok:r.ok,status:r.status,url:r.url||n,contentType:o,truncated:s};if(!a)return{...u,text:c};try{return{...u,data:c?JSON.parse(c):null}}catch{return{...u,ok:!1,text:c,error:"The Internet response was not valid JSON."}}}catch(r){return{ok:!1,status:0,url:n,contentType:"",error:(r==null?void 0:r.message)||"Internet request failed."}}}function rn(e=[],t={}){return Array.isArray(e)?e.filter(n=>n==null?void 0:n.token).map(n=>{const a=Object.prototype.hasOwnProperty.call(t,n.token)?t[n.token]:n.previewValue;return{token:n.token,label:n.label||n.token,key:n.key||"",inputType:n.input_type||n.inputType||"text",value:a??"",internal:!!n.internal,aliases:Array.isArray(n.searchAliases)?n.searchAliases.filter(Boolean):[]}}):[]}function N(e){return e==null?"":typeof e=="string"?e.trim():typeof e=="number"||typeof e=="boolean"?String(e):""}function X(e=""){return String(e||"").replace(/[{}]/g,"").replace(/([a-z0-9])([A-Z])/g,"$1 $2").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/&/g,"and").replace(/[^a-z0-9]+/g,"")}function qe(e=""){return String(e||"").replace(/[{}]/g,"").replace(/([a-z0-9])([A-Z])/g,"$1 $2").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/&/g,"and").replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}function Je(e=""){const t=qe(e);return t?t.replace(/_([a-z0-9])/g,(n,a)=>a.toUpperCase()):""}function V(e=""){const t=Je(e);return t?/^[A-Za-z_$]/.test(t)?t:`field${t.charAt(0).toUpperCase()}${t.slice(1)}`:""}function he(e=""){return String(e||"").split(".").map(t=>t.trim()).filter(Boolean)}function F(e,t){const n=String(t||"").trim();!n||e.includes(n)||e.push(n)}function I(e,t){const n=String(t||"").trim();if(!n)return;F(e,n);const a=qe(n),r=Je(n);a&&(F(e,a),F(e,`{${a}}`)),r&&F(e,r)}function He({label:e="",token:t="",key:n="",aliases:a=[],section:r=""}={}){const o=[];I(o,e),I(o,t),I(o,t.replace(/[{}]/g,"")),I(o,n);const i=he(n);return i.length>0&&(I(o,i[i.length-1]),I(o,i.join(" ")),I(o,i.join(""))),I(o,r),a.forEach(s=>I(o,s)),o}function on(e){const t=N(e.value);if(t==="")return null;const n={label:String(e.label||e.token||e.key||"Field"),value:t,source:e.source||"context"};return e.token&&(n.token=String(e.token)),e.key&&(n.key=String(e.key)),e.section&&(n.section=String(e.section)),n.aliases=He({...e,...n}),n}function sn({tokens:e=[],clientInfo:t=[],clientSummary:n=[],profile:a=null}={}){const r=[],o=new Set,i=s=>{const c=on(s);if(!c)return;const u=`${c.source}:${c.label}:${c.value}:${c.token||""}:${c.key||""}`;o.has(u)||(o.add(u),r.push(c))};return e.forEach(s=>{i({label:s.label,value:s.value,token:s.token,key:s.key,aliases:s.aliases,source:"token"})}),n.forEach(s=>{i({label:s.label,value:s.value,section:"summary",source:"clientSummary"})}),t.forEach(s=>{((s==null?void 0:s.fields)||[]).forEach(c=>{i({label:c.label,value:c.value,section:s.title||s.id,source:"clientInfo"})})}),a&&typeof a=="object"&&(Array.isArray(a.availableFields)?a.availableFields:[]).forEach(s=>{i({label:s.label,value:s.value,key:s.key,aliases:s.aliases,source:"profile"})}),r}function ln(e,t,n){!t||n===""||Object.prototype.hasOwnProperty.call(e,t)||(e[t]=n)}function cn(e,t,n){const a=he(t);if(a.length<2||n==="")return;let r=e;for(let i=0;i<a.length-1;i+=1){const s=a[i];if(!s||/^\d+$/.test(s)||(r[s]===void 0&&(r[s]={}),!r[s]||typeof r[s]!="object"||Array.isArray(r[s])))return;r=r[s]}const o=a[a.length-1];o&&!Object.prototype.hasOwnProperty.call(r,o)&&(r[o]=n)}function un(e={},t=[]){const n={...e};return t.forEach(a=>{a.key&&cn(n,a.key,a.value),a.aliases.forEach(r=>ln(n,r,a.value))}),Ye(n,t),n}const dn=Object.freeze([{name:"clientName",candidates:["clientName","client name","fullName","full name","name","client.name"]}]);function mn(e,t){const n=X(t);return!e||!n?!1:[e.label,e.token,e.key,...e.aliases||[]].some(a=>X(a)===n)}function pn(e=[],t=[]){for(const n of t){const a=e.find(o=>mn(o,n)),r=N(a==null?void 0:a.value);if(r!=="")return r}return""}function Ye(e,t=[]){dn.forEach(({name:n,candidates:a})=>{if(Object.prototype.hasOwnProperty.call(e,n))return;const r=pn(t,a);r!==""&&(e[n]=r)})}function fn({tokens:e=[],fields:t=[],variables:n={}}={}){const a=[],r=new Set,o=i=>{const s=Array.isArray(i.names)?i.names.filter(Boolean):[],c=[i.token||"",i.key||"",i.label||"",i.source||"",s.join("|")].join(":");r.has(c)||(r.add(c),a.push({name:s[0]||i.token||i.key||i.label||"",names:s,token:i.token||"",key:i.key||"",label:i.label||"",value:N(i.value),source:i.source||"context",inputType:i.inputType||"",internal:!!i.internal}))};return e.forEach(i=>{const c=He({label:i.label,token:i.token,key:i.key,aliases:i.aliases}).map(V).filter(Boolean);o({names:[...new Set(c)],token:i.token,key:i.key,label:i.label,value:i.value,source:"token",inputType:i.inputType,internal:i.internal})}),t.forEach(i=>{const c=[i.label,i.token,i.key,...i.aliases||[]].map(V).filter(Boolean);o({names:[...new Set(c)],token:i.token,key:i.key,label:i.label,value:i.value,source:i.source})}),Object.entries(n).forEach(([i,s])=>{!i||s===null||typeof s=="object"||o({names:[i],label:i,value:s,source:"variable"})}),a.sort((i,s)=>i.name.localeCompare(s.name))}function bn(e=[]){const t={};return e.forEach(n=>{[n.label,n.token,n.key,...n.aliases||[]].forEach(a=>{const r=X(a);!r||t[r]||(t[r]={label:n.label,value:n.value,source:n.source,token:n.token||"",key:n.key||"",section:n.section||""})})}),t}function P(e,t,n){const a=V(t);!a||n===""||Object.prototype.hasOwnProperty.call(e,a)||(e[a]=n)}function hn(e,t,n){const a=he(t).map(V).filter(Boolean);if(a.length<2||n==="")return;let r=e;for(let i=0;i<a.length-1;i+=1){const s=a[i];if(r[s]===void 0&&(r[s]={}),!r[s]||typeof r[s]!="object"||Array.isArray(r[s]))return;r=r[s]}const o=a[a.length-1];o&&!Object.prototype.hasOwnProperty.call(r,o)&&(r[o]=n)}function gn(e,t=null){if(!t||typeof t!="object")return;const n=t.vars&&typeof t.vars=="object"?t.vars:t.variables&&typeof t.variables=="object"?t.variables:{};Object.entries(n).forEach(([a,r])=>{const o=N(r);o!==""&&P(e,a,o)})}function Tn({fields:e=[],tokens:t=[],tokenValues:n={},environment:a={},profile:r=null}={}){const o={env:a,raw:n,byToken:{},byKey:{},byLabel:{},available:[],availableTokens:[],availableFields:[]};return t.forEach(i=>{i.token&&(o.byToken[i.token]=N(i.value))}),Object.entries(n||{}).forEach(([i,s])=>{const c=N(s);o.byToken[i]=c,c!==""&&(P(o,i,c),P(o,i.replace(/[{}]/g,""),c))}),gn(o,r),e.forEach(i=>{const s=N(i.value);s!==""&&(i.token&&(o.byToken[i.token]=s),i.key&&(o.byKey[i.key]=s,hn(o,i.key,s)),o.byLabel[i.label]=s,[i.label,i.token,i.key,...i.aliases||[]].forEach(c=>{P(o,c,s)}))}),Ye(o,e),o.available=fn({tokens:t,fields:e,variables:o}),o.availableTokens=o.available.filter(i=>i.token),o.availableFields=e.map(i=>({name:V(i.key||i.token||i.label),token:i.token||"",key:i.key||"",label:i.label||"",value:i.value,source:i.source||"context",aliases:i.aliases||[]})),o}function ma({tool:e={},values:t={},tokens:n=[],client:a=null,clientInfo:r=[],clientSummary:o=[],profile:i=null}={}){const s=t&&typeof t=="object"?t:{},c=i&&typeof i=="object"?i:null,u=c!=null&&c.tokenValues&&typeof c.tokenValues=="object"?c.tokenValues:{},l={...s,...u},d=Array.isArray(r)?r:[],m=Array.isArray(o)?o:[],b=rn(n,l),h=sn({tokens:b,clientInfo:d,clientSummary:m,profile:c}),f=new Date().toISOString(),T={apiVersion:K,toolId:e.id||"",toolTitle:e.title||"",toolDescription:e.description||"",generatedAt:f};return{apiVersion:K,tool:{id:e.id||"",title:e.title||"",description:e.description||""},profile:c||null,values:un(l,h),tokenValues:l,tokens:b,fields:h,fieldIndex:bn(h),variables:Tn({fields:h,tokens:b,tokenValues:l,environment:T,profile:c}),environment:T,client:a&&typeof a=="object"?a:null,clientInfo:d,clientSummary:m,generatedAt:f}}function yn(e=""){const t=String(e||"").trim(),n=t.match(/^```(?:json|text)?\s*([\s\S]*?)\s*```$/i);return n?n[1].trim():t}function pa(e=""){const t=yn(e);if(!t)return"";try{const n=JSON.parse(t);return n&&typeof n=="object"&&!Array.isArray(n)&&typeof n.html=="string"&&n.html.trim()?n.html.trim():""}catch{return""}}function z(e=""){const t=N(e);return t?`value: ${t.slice(0,80)}${t.length>80?"…":""}`:"empty now"}function kn(e={}){const t=Array.isArray(e.names)?e.names.filter(Boolean):[];return[...new Set([e.name,...t].filter(Boolean))].slice(0,8).join(", ")}function vn(e=null){var c;if(!e||typeof e!="object")return"No live app context was loaded while copying this prompt. The module must discover variables at runtime with TemplateTool.getContext(), TemplateTool.getVars(), TemplateTool.listVariables(), context.tokens and context.fields.";const t=["Live variable inventory from the current app context:","Use these exact names/tokens/keys when they fit the request, and still keep runtime fallbacks because availability changes per customer."],n=e.profile&&typeof e.profile=="object"?e.profile:null,a=n!=null&&n.vars&&typeof n.vars=="object"?n.vars:{},r=Object.entries(a).filter(([,u])=>N(u)!=="").sort(([u],[l])=>u.localeCompare(l));r.length>0&&(t.push("","Profile variables (TemplateProfile / TemplateVars aliases):"),r.forEach(([u,l])=>{t.push(`- ${u} (${z(l)})`)}));const o=Array.isArray((c=e.variables)==null?void 0:c.available)?e.variables.available:[];o.length>0&&(t.push("","Discoverable TemplateVars.available entries:"),o.forEach(u=>{const l=[u.token?`token ${u.token}`:"",u.key?`key ${u.key}`:"",u.label?`label ${u.label}`:"",`names: ${kn(u)||"none"}`,`source ${u.source||"context"}`,z(u.value)].filter(Boolean);t.push(`- ${l.join("; ")}`)}));const i=Array.isArray(e.fields)?e.fields:[];i.length>0&&(t.push("","Resolved context.fields (preferred for visible customer data):"),i.forEach(u=>{const l=[u.label?`label ${u.label}`:"",u.token?`token ${u.token}`:"",u.key?`key ${u.key}`:"",u.section?`section ${u.section}`:"",`source ${u.source||"context"}`,z(u.value)].filter(Boolean);t.push(`- ${l.join("; ")}`)}));const s=Array.isArray(e.tokens)?e.tokens:[];return s.length>0&&(t.push("","All configured context.tokens, including empty values:"),s.forEach(u=>{const l=[u.token?`token ${u.token}`:"",u.key?`key ${u.key}`:"",u.label?`label ${u.label}`:"",u.inputType?`type ${u.inputType}`:"",u.internal?"internal":"manual/configured",z(u.value)].filter(Boolean);t.push(`- ${l.join("; ")}`)})),r.length===0&&o.length===0&&i.length===0&&s.length===0&&t.push("- No variables are currently configured or populated in this context. Build a missing-data state and rely on runtime discovery."),t.join(`
`)}function fa({title:e="",prompt:t="",runtimeContext:n=null}={}){const a=String(e||"").trim()||"Custom tool",r=String(t||"").trim()||"Create a useful workflow tool for my Template Generator app.";return`You are building a custom Beta module for a local app called Template Generator.
