...
</html>`:dn}function fn(e,t,n){return e.includes(n)?e:/<\/head\s*>/i.test(e)?e.replace(/<\/head\s*>/i,`${t}</head>`):/<head[\s>]/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>${t}`):/<html[\s>]/i.test(e)?e.replace(/<html([^>]*)>/i,`<html$1>${t}`):`${t}${e}`}function bn(e,t,n){return e.includes(n)?e:/<head[\s>]/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>${t}`):/<html[\s>]/i.test(e)?e.replace(/<html([^>]*)>/i,`<html$1>${t}`):`${t}${e}`}function Cr(e=""){const t=pn(e),n=bn(t,un,"template-tool-bridge");return fn(n,cn,"template-tool-host-style")}function hn(e=[],t={}){return Array.isArray(e)?e.filter(n=>n==null?void 0:n.token).map(n=>{const r=Object.prototype.hasOwnProperty.call(t,n.token)?t[n.token]:n.previewValue;return{token:n.token,label:n.label||n.token,key:n.key||"",inputType:n.input_type||n.inputType||"text",value:r??"",internal:!!n.internal,aliases:Array.isArray(n.searchAliases)?n.searchAliases.filter(Boolean):[]}}):[]}function N(e){return e==null?"":typeof e=="string"?e.trim():typeof e=="number"||typeof e=="boolean"?String(e):""}function te(e=""){return String(e||"").replace(/[{}]/g,"").replace(/([a-z0-9])([A-Z])/g,"$1 $2").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/&/g,"and").replace(/[^a-z0-9]+/g,"")}function He(e=""){return String(e||"").replace(/[{}]/g,"").replace(/([a-z0-9])([A-Z])/g,"$1 $2").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/&/g,"and").replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}function Ge(e=""){const t=He(e);return t?t.replace(/_([a-z0-9])/g,(n,r)=>r.toUpperCase()):""}function j(e=""){const t=Ge(e);return t?/^[A-Za-z_$]/.test(t)?t:`field${t.charAt(0).toUpperCase()}${t.slice(1)}`:""}function ge(e=""){return String(e||"").split(".").map(t=>t.trim()).filter(Boolean)}function B(e,t){const n=String(t||"").trim();!n||e.includes(n)||e.push(n)}function I(e,t){const n=String(t||"").trim();if(!n)return;B(e,n);const r=He(n),a=Ge(n);r&&(B(e,r),B(e,`{${r}}`)),a&&B(e,a)}function Ze({label:e="",token:t="",key:n="",aliases:r=[],section:a=""}={}){const i=[];I(i,e),I(i,t),I(i,t.replace(/[{}]/g,"")),I(i,n);const o=ge(n);return o.length>0&&(I(i,o[o.length-1]),I(i,o.join(" ")),I(i,o.join(""))),I(i,a),r.forEach(s=>I(i,s)),i}function gn(e){const t=N(e.value);if(t==="")return null;const n={label:String(e.label||e.token||e.key||"Field"),value:t,source:e.source||"context"};return e.token&&(n.token=String(e.token)),e.key&&(n.key=String(e.key)),e.section&&(n.section=String(e.section)),n.aliases=Ze({...e,...n}),n}function Tn({tokens:e=[],clientInfo:t=[],clientSummary:n=[],profile:r=null}={}){const a=[],i=new Set,o=s=>{const c=gn(s);if(!c)return;const u=`${c.source}:${c.label}:${c.value}:${c.token||""}:${c.key||""}`;i.has(u)||(i.add(u),a.push(c))};return e.forEach(s=>{o({label:s.label,value:s.value,token:s.token,key:s.key,aliases:s.aliases,source:"token"})}),n.forEach(s=>{o({label:s.label,value:s.value,section:"summary",source:"clientSummary"})}),t.forEach(s=>{((s==null?void 0:s.fields)||[]).forEach(c=>{o({label:c.label,value:c.value,section:s.title||s.id,source:"clientInfo"})})}),r&&typeof r=="object"&&(Array.isArray(r.availableFields)?r.availableFields:[]).forEach(s=>{o({label:s.label,value:s.value,key:s.key,aliases:s.aliases,source:"profile"})}),a}function yn(e,t,n){!t||n===""||Object.prototype.hasOwnProperty.call(e,t)||(e[t]=n)}function kn(e,t,n){const r=ge(t);if(r.length<2||n==="")return;let a=e;for(let o=0;o<r.length-1;o+=1){const s=r[o];if(!s||/^\d+$/.test(s)||(a[s]===void 0&&(a[s]={}),!a[s]||typeof a[s]!="object"||Array.isArray(a[s])))return;a=a[s]}const i=r[r.length-1];i&&!Object.prototype.hasOwnProperty.call(a,i)&&(a[i]=n)}function vn(e={},t=[]){const n={...e};return t.forEach(r=>{r.key&&kn(n,r.key,r.value),r.aliases.forEach(a=>yn(n,a,r.value))}),Xe(n,t),n}const xn=Object.freeze([{name:"clientName",candidates:["clientName","client name","fullName","full name","name","client.name"]}]);function wn(e,t){const n=te(t);return!e||!n?!1:[e.label,e.token,e.key,...e.aliases||[]].some(r=>te(r)===n)}function In(e=[],t=[]){for(const n of t){const r=e.find(i=>wn(i,n)),a=N(r==null?void 0:r.value);if(a!=="")return a}return""}function Xe(e,t=[]){xn.forEach(({name:n,candidates:r})=>{if(Object.prototype.hasOwnProperty.call(e,n))return;const a=In(t,r);a!==""&&(e[n]=a)})}function Nn({tokens:e=[],fields:t=[],variables:n={}}={}){const r=[],a=new Set,i=o=>{const s=Array.isArray(o.names)?o.names.filter(Boolean):[],c=[o.token||"",o.key||"",o.label||"",o.source||"",s.join("|")].join(":");a.has(c)||(a.add(c),r.push({name:s[0]||o.token||o.key||o.label||"",names:s,token:o.token||"",key:o.key||"",label:o.label||"",value:N(o.value),source:o.source||"context",inputType:o.inputType||"",internal:!!o.internal}))};return e.forEach(o=>{const c=Ze({label:o.label,token:o.token,key:o.key,aliases:o.aliases}).map(j).filter(Boolean);i({names:[...new Set(c)],token:o.token,key:o.key,label:o.label,value:o.value,source:"token",inputType:o.inputType,internal:o.internal})}),t.forEach(o=>{const c=[o.label,o.token,o.key,...o.aliases||[]].map(j).filter(Boolean);i({names:[...new Set(c)],token:o.token,key:o.key,label:o.label,value:o.value,source:o.source})}),Object.entries(n).forEach(([o,s])=>{!o||s===null||typeof s=="object"||i({names:[o],label:o,value:s,source:"variable"})}),r.sort((o,s)=>o.name.localeCompare(s.name))}function Sn(e=[]){const t={};return e.forEach(n=>{[n.label,n.token,n.key,...n.aliases||[]].forEach(r=>{const a=te(r);!a||t[a]||(t[a]={label:n.label,value:n.value,source:n.source,token:n.token||"",key:n.key||"",section:n.section||""})})}),t}function P(e,t,n){const r=j(t);!r||n===""||Object.prototype.hasOwnProperty.call(e,r)||(e[r]=n)}function An(e,t,n){const r=ge(t).map(j).filter(Boolean);if(r.length<2||n==="")return;let a=e;for(let o=0;o<r.length-1;o+=1){const s=r[o];if(a[s]===void 0&&(a[s]={}),!a[s]||typeof a[s]!="object"||Array.isArray(a[s]))return;a=a[s]}const i=r[r.length-1];i&&!Object.prototype.hasOwnProperty.call(a,i)&&(a[i]=n)}function Cn(e,t=null){if(!t||typeof t!="object")return;const n=t.vars&&typeof t.vars=="object"?t.vars:t.variables&&typeof t.variables=="object"?t.variables:{};Object.entries(n).forEach(([r,a])=>{const i=N(a);i!==""&&P(e,r,i)})}function En({fields:e=[],tokens:t=[],tokenValues:n={},environment:r={},profile:a=null}={}){const i={env:r,raw:n,byToken:{},byKey:{},byLabel:{},available:[],availableTokens:[],availableFields:[]};return t.forEach(o=>{o.token&&(i.byToken[o.token]=N(o.value))}),Object.entries(n||{}).forEach(([o,s])=>{const c=N(s);i.byToken[o]=c,c!==""&&(P(i,o,c),P(i,o.replace(/[{}]/g,""),c))}),Cn(i,a),e.forEach(o=>{const s=N(o.value);s!==""&&(o.token&&(i.byToken[o.token]=s),o.key&&(i.byKey[o.key]=s,An(i,o.key,s)),i.byLabel[o.label]=s,[o.label,o.token,o.key,...o.aliases||[]].forEach(c=>{P(i,c,s)}))}),Xe(i,e),i.available=Nn({tokens:t,fields:e,variables:i}),i.availableTokens=i.available.filter(o=>o.token),i.availableFields=e.map(o=>({name:j(o.key||o.token||o.label),token:o.token||"",key:o.key||"",label:o.label||"",value:o.value,source:o.source||"context",aliases:o.aliases||[]})),i}function Er({tool:e={},values:t={},tokens:n=[],client:r=null,clientInfo:a=[],clientSummary:i=[],profile:o=null}={}){const s=t&&typeof t=="object"?t:{},c=o&&typeof o=="object"?o:null,u=c!=null&&c.tokenValues&&typeof c.tokenValues=="object"?c.tokenValues:{},l={...s,...u},d=Array.isArray(a)?a:[],m=Array.isArray(i)?i:[],f=hn(n,l),b=Tn({tokens:f,clientInfo:d,clientSummary:m,profile:c}),y=new Date().toISOString(),v={apiVersion:J,toolId:e.id||"",toolTitle:e.title||"",toolDescription:e.description||"",generatedAt:y};return{apiVersion:J,tool:{id:e.id||"",title:e.title||"",description:e.description||""},profile:c||null,values:vn(l,b),tokenValues:l,tokens:f,fields:b,fieldIndex:Sn(b),variables:En({fields:b,tokens:f,tokenValues:l,environment:v,profile:c}),environment:v,client:r&&typeof r=="object"?r:null,clientInfo:d,clientSummary:m,generatedAt:y}}function _n(e=""){const t=String(e||"").trim(),n=t.match(/^```(?:json|text)?\s*([\s\S]*?)\s*```$/i);return n?n[1].trim():t}function _r(e=""){const t=_n(e);if(!t)return"";try{const n=JSON.parse(t);return n&&typeof n=="object"&&!Array.isArray(n)&&typeof n.html=="string"&&n.html.trim()?n.html.trim():""}catch{return""}}function M(e=""){const t=N(e);return t?`value: ${t.slice(0,80)}${t.length>80?"…":""}`:"empty now"}function Ln(e={}){const t=Array.isArray(e.names)?e.names.filter(Boolean):[];return[...new Set([e.name,...t].filter(Boolean))].slice(0,8).join(", ")}function On(e=null){var c;if(!e||typeof e!="object")return"No live app context was loaded while copying this prompt. The module must discover variables at runtime with TemplateTool.getContext(), TemplateTool.getVars(), TemplateTool.listVariables(), context.tokens and context.fields.";const t=["Live variable inventory from the current app context:","Use these exact names/tokens/keys when they fit the request, and still keep runtime fallbacks because availability changes per customer."],n=e.profile&&typeof e.profile=="object"?e.profile:null,r=n!=null&&n.vars&&typeof n.vars=="object"?n.vars:{},a=Object.entries(r).filter(([,u])=>N(u)!=="").sort(([u],[l])=>u.localeCompare(l));a.length>0&&(t.push("","Profile variables (TemplateProfile / TemplateVars aliases):"),a.forEach(([u,l])=>{t.push(`- ${u} (${M(l)})`)}));const i=Array.isArray((c=e.variables)==null?void 0:c.available)?e.variables.available:[];i.length>0&&(t.push("","Discoverable TemplateVars.available entries:"),i.forEach(u=>{const l=[u.token?`token ${u.token}`:"",u.key?`key ${u.key}`:"",u.label?`label ${u.label}`:"",`names: ${Ln(u)||"none"}`,`source ${u.source||"context"}`,M(u.value)].filter(Boolean);t.push(`- ${l.join("; ")}`)}));const o=Array.isArray(e.fields)?e.fields:[];o.length>0&&(t.push("","Resolved context.fields (preferred for visible customer data):"),o.forEach(u=>{const l=[u.label?`label ${u.label}`:"",u.token?`token ${u.token}`:"",u.key?`key ${u.key}`:"",u.section?`section ${u.section}`:"",`source ${u.source||"context"}`,M(u.value)].filter(Boolean);t.push(`- ${l.join("; ")}`)}));const s=Array.isArray(e.tokens)?e.tokens:[];return s.length>0&&(t.push("","All configured context.tokens, including empty values:"),s.forEach(u=>{const l=[u.token?`token ${u.token}`:"",u.key?`key ${u.key}`:"",u.label?`label ${u.label}`:"",u.inputType?`type ${u.inputType}`:"",u.internal?"internal":"manual/configured",M(u.value)].filter(Boolean);t.push(`- ${l.join("; ")}`)})),a.length===0&&i.length===0&&o.length===0&&s.length===0&&t.push("- No variables are currently configured or populated in this context. Build a missing-data state and rely on runtime discovery."),t.join(`
`)}function Lr({title:e="",prompt:t="",runtimeContext:n=null}={}){const r=String(e||"").trim()||"Custom tool",a=String(t||"").trim()||"Create a useful workflow tool for my Template Generator app.";return`You are building a custom Beta module for a local app called Template Generator.
