...
(function () {
    var apiVersion = "${h}";
    var apiReference = ${JSON.stringify(S)};
    var requestId = 0;
    var pending = new Map();
...
</html>`;function Z(e=""){var c;const t=String(e||"").replace(/^\uFEFF/,"").trim();if(!t)return"";const a=t.match(/```(?:html)?\s*([\s\S]*?)```/i),o=((c=a==null?void 0:a[1])==null?void 0:c.trim())||t,n=o.match(/<!doctype\s+html\b|<html[\s>]/i);if(!n)return o;const i=n.index||0,r=o.slice(i).trim(),l=r.match(/<\/html\s*>/i);return l?r.slice(0,l.index+l[0].length).trim():r}function Q(e=""){const t=Z(e);return t?/<!doctype|<html[\s>]/i.test(t)?t:`<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
...
</html>`:J}function W(e,t,a){return e.includes(a)?e:/<\/head\s*>/i.test(e)?e.replace(/<\/head\s*>/i,`${t}</head>`):/<head[\s>]/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>${t}`):/<html[\s>]/i.test(e)?e.replace(/<html([^>]*)>/i,`<html$1>${t}`):`${t}${e}`}function X(e,t,a){return e.includes(a)?e:/<head[\s>]/i.test(e)?e.replace(/<head([^>]*)>/i,`<head$1>${t}`):/<html[\s>]/i.test(e)?e.replace(/<html([^>]*)>/i,`<html$1>${t}`):`${t}${e}`}function Ee(e=""){const t=Q(e),a=X(t,G,"template-tool-bridge");return W(a,Y,"template-tool-host-style")}function ee(e=[],t={}){return Array.isArray(e)?e.filter(a=>a==null?void 0:a.token).map(a=>{const o=Object.prototype.hasOwnProperty.call(t,a.token)?t[a.token]:a.previewValue;return{token:a.token,label:a.label||a.token,key:a.key||"",inputType:a.input_type||a.inputType||"text",value:o??"",internal:!!a.internal,aliases:Array.isArray(a.searchAliases)?a.searchAliases.filter(Boolean):[]}}):[]}function y(e){return e==null?"":typeof e=="string"?e.trim():typeof e=="number"||typeof e=="boolean"?String(e):""}function g(e=""){return String(e||"").replace(/[{}]/g,"").replace(/([a-z0-9])([A-Z])/g,"$1 $2").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/&/g,"and").replace(/[^a-z0-9]+/g,"")}function O(e=""){return String(e||"").replace(/[{}]/g,"").replace(/([a-z0-9])([A-Z])/g,"$1 $2").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/&/g,"and").replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")}function A(e=""){const t=O(e);return t?t.replace(/_([a-z0-9])/g,(a,o)=>o.toUpperCase()):""}function I(e=""){const t=A(e);return t?/^[A-Za-z_$]/.test(t)?t:`field${t.charAt(0).toUpperCase()}${t.slice(1)}`:""}function T(e=""){return String(e||"").split(".").map(t=>t.trim()).filter(Boolean)}function m(e,t){const a=String(t||"").trim();!a||e.includes(a)||e.push(a)}function s(e,t){const a=String(t||"").trim();if(!a)return;m(e,a);const o=O(a),n=A(a);o&&(m(e,o),m(e,`{${o}}`)),n&&m(e,n)}function te({label:e="",token:t="",key:a="",aliases:o=[],section:n=""}={}){const i=[];s(i,e),s(i,t),s(i,t.replace(/[{}]/g,"")),s(i,a);const r=T(a);return r.length>0&&(s(i,r[r.length-1]),s(i,r.join(" ")),s(i,r.join(""))),s(i,n),o.forEach(l=>s(i,l)),i}function ae(e){const t=y(e.value);if(t==="")return null;const a={label:String(e.label||e.token||e.key||"Field"),value:t,source:e.source||"context"};return e.token&&(a.token=String(e.token)),e.key&&(a.key=String(e.key)),e.section&&(a.section=String(e.section)),a.aliases=te({...e,...a}),a}function oe({tokens:e=[],clientInfo:t=[],clientSummary:a=[]}={}){const o=[],n=new Set,i=r=>{const l=ae(r);if(!l)return;const c=`${l.source}:${l.label}:${l.value}:${l.token||""}:${l.key||""}`;n.has(c)||(n.add(c),o.push(l))};return e.forEach(r=>{i({label:r.label,value:r.value,token:r.token,key:r.key,aliases:r.aliases,source:"token"})}),a.forEach(r=>{i({label:r.label,value:r.value,section:"summary",source:"clientSummary"})}),t.forEach(r=>{((r==null?void 0:r.fields)||[]).forEach(l=>{i({label:l.label,value:l.value,section:r.title||r.id,source:"clientInfo"})})}),o}function ne(e,t,a){!t||a===""||Object.prototype.hasOwnProperty.call(e,t)||(e[t]=a)}function re(e,t,a){const o=T(t);if(o.length<2||a==="")return;let n=e;for(let r=0;r<o.length-1;r+=1){const l=o[r];if(!l||/^\d+$/.test(l)||(n[l]===void 0&&(n[l]={}),!n[l]||typeof n[l]!="object"||Array.isArray(n[l])))return;n=n[l]}const i=o[o.length-1];i&&!Object.prototype.hasOwnProperty.call(n,i)&&(n[i]=a)}function ie(e={},t=[]){const a={...e};return t.forEach(o=>{o.key&&re(a,o.key,o.value),o.aliases.forEach(n=>ne(a,n,o.value))}),L(a,t),a}const le=Object.freeze([{name:"clientName",candidates:["clientName","client name","fullName","full name","name","client.name"]}]);function se(e,t){const a=g(t);return!e||!a?!1:[e.label,e.token,e.key,...e.aliases||[]].some(o=>g(o)===a)}function ce(e=[],t=[]){for(const a of t){const o=e.find(i=>se(i,a)),n=y(o==null?void 0:o.value);if(n!=="")return n}return""}function L(e,t=[]){le.forEach(({name:a,candidates:o})=>{if(Object.prototype.hasOwnProperty.call(e,a))return;const n=ce(t,o);n!==""&&(e[a]=n)})}function de(e=[]){const t={};return e.forEach(a=>{[a.label,a.token,a.key,...a.aliases||[]].forEach(o=>{const n=g(o);!n||t[n]||(t[n]={label:a.label,value:a.value,source:a.source,token:a.token||"",key:a.key||"",section:a.section||""})})}),t}function b(e,t,a){const o=I(t);!o||a===""||Object.prototype.hasOwnProperty.call(e,o)||(e[o]=a)}function ue(e,t,a){const o=T(t).map(I).filter(Boolean);if(o.length<2||a==="")return;let n=e;for(let r=0;r<o.length-1;r+=1){const l=o[r];if(n[l]===void 0&&(n[l]={}),!n[l]||typeof n[l]!="object"||Array.isArray(n[l]))return;n=n[l]}const i=o[o.length-1];i&&!Object.prototype.hasOwnProperty.call(n,i)&&(n[i]=a)}function pe({fields:e=[],tokenValues:t={},environment:a={}}={}){const o={env:a,raw:t,byToken:{},byKey:{},byLabel:{}};return Object.entries(t||{}).forEach(([n,i])=>{const r=y(i);r!==""&&(o.byToken[n]=r,b(o,n,r),b(o,n.replace(/[{}]/g,""),r))}),e.forEach(n=>{const i=y(n.value);i!==""&&(n.token&&(o.byToken[n.token]=i),n.key&&(o.byKey[n.key]=i,ue(o,n.key,i)),o.byLabel[n.label]=i,[n.label,n.token,n.key,...n.aliases||[]].forEach(r=>{b(o,r,i)}))}),L(o,e),o}function ze({tool:e={},values:t={},tokens:a=[],client:o=null,clientInfo:n=[],clientSummary:i=[]}={}){const r=t&&typeof t=="object"?t:{},l=Array.isArray(n)?n:[],c=Array.isArray(i)?i:[],w=ee(a,r),p=oe({tokens:w,clientInfo:l,clientSummary:c}),v=new Date().toISOString(),x={apiVersion:h,toolId:e.id||"",toolTitle:e.title||"",toolDescription:e.description||"",generatedAt:v};return{apiVersion:h,tool:{id:e.id||"",title:e.title||"",description:e.description||""},values:ie(r,p),tokenValues:r,tokens:w,fields:p,fieldIndex:de(p),variables:pe({fields:p,tokenValues:r,environment:x}),environment:x,client:o&&typeof o=="object"?o:null,clientInfo:l,clientSummary:c,generatedAt:v}}function Me({title:e="",prompt:t=""}={}){const a=String(e||"").trim()||"Custom tool",o=String(t||"").trim()||"Create a useful workflow tool for my Template Generator app.";return`You are building a custom Beta module for a local app called Template Generator.
...
User request:
${o}`}const me=Object.freeze([{id:"importVti",label:"Import VTI data",key:"q",code:"KeyQ",altKey:!0},{id:"importSo",label:"Import SO data",key:"w",code:"KeyW",altKey:!0},{id:"clearData",label:"Clear imported data",key:"e",code:"KeyE",altKey:!0}]),fe=["input","textarea","select","[contenteditable='true']","[contenteditable='']","[role='textbox']"].join(",");function f(e,t){return!!(e!=null&&e[t])}function he(e,t){return String(e||"").toLowerCase()===String(t||"").toLowerCase()}function E(e,t){return!!t&&String(e||"").toLowerCase()===String(t||"").toLowerCase()}function ye(e,t){return f(e,"ctrlKey")===!!t.ctrlKey&&f(e,"altKey")===!!t.altKey&&f(e,"shiftKey")===!!t.shiftKey&&f(e,"metaKey")===!!t.metaKey}function be(e,t){return ye(e,t)&&(he(e==null?void 0:e.key,t.key)||E(e==null?void 0:e.code,t.code))}function je(e){return e?[e.ctrlKey?"Ctrl":"",e.altKey?"Alt":"",e.shiftKey?"Shift":"",e.metaKey?"Meta":"",e.key].filter(Boolean).join("+"):""}function ge(e){return!e||e===(typeof document>"u"?null:document)||e===(typeof window>"u"?null:window)?!1:!!(typeof e.closest=="function"&&e.closest(fe))}function Te(e){return!!(e!=null&&e.defaultPrevented||e!=null&&e.repeat||ge(e==null?void 0:e.target))}function Pe(e){if(Te(e))return null;const t=me.find(a=>be(e,a))||null;return!t||e!=null&&e.isComposing&&!E(e==null?void 0:e.code,t.code)?null:t}export{xe as C,U as D,ke as E,me as K,Ce as P,Ve as T,Se as U,ze as a,Ee as b,Ae as c,d,C as e,je as f,Pe as g,Me as h,Le as i,K as j,Oe as l,V as n,Ie as r,B as s};
