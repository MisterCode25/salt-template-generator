...
function ClientInfoPanel({
    ...
    const summaryDetailLabels = new Set([
        "Full name",
        "Title",
        "First name",
        "Last name",
        ...
        "contact activation Date",
        "healthcheck activation Date",
        "OTO ID",
        "OTO port"
    ]);
    const detailSections = sections
        .map((section) => ({
            ...section,
            fields: section.fields.filter((field) => !summaryDetailLabels.has(field.label))
        }))
                        ...
                        <div className="client-info-summary-action">
                            ...
                            >
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                                    {detailsExpanded ? <path d="m18 15-6-6-6 6" /> : <path d="m6 9 6 6 6-6" />}
                                </svg>
                            </button>
                        </div>
                    </div>

                    {detailsExpanded && detailSections.length > 0 && (
