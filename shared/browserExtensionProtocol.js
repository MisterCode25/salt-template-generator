...
export const BROWSER_EXTENSION_MESSAGE = Object.freeze({
    ...
    ALO_TICKET_CREATED: "salt.capture.alo.created.v1",
    ALO_RESULTS_REQUEST: "salt.capture.alo.results.request.v1",
    ALO_RESULT_ACK: "salt.capture.alo.result.ack.v1",
...
const APP_MESSAGE_TYPES = new Set([
    ...
    BROWSER_EXTENSION_MESSAGE.ALO_RESULTS_REQUEST,
    BROWSER_EXTENSION_MESSAGE.ALO_RESULT_ACK,
...
const EXTENSION_MESSAGE_TYPES = new Set([
    ...
    BROWSER_EXTENSION_MESSAGE.ALO_TICKET_CREATED,
